...
To embed _CCF-RUI_ the following code snippet should be used.
...
_CCF-RUI_ can be customized in the following ways:
...
To embed _CCF-EUI_ the following code snippet should be used.
...
_CCF-EUI_ can be customized in the following ways:
...
To embed _CCF-ORGAN-INFO_ the following code snippet should be used.
...
_CCF-ORGAN-INFO_ can be customized in the following ways:
...
To embed _CCF-BODY-UI-WC_ the following code snippet should be used.
...
_CCF-BODY-UI-WC_ can be customized in the following ways:
      ...
      const sampleData = [
        {
          ...
          rui_location: {
            ...
            '@type': 'SpatialEntity',
            ccf_annotations: ['http://purl.obolibrary.org/obo/UBERON_0002084', 'http://purl.obolibrary.org/obo/UBERON_0002494', 'http://purl.org/sig/ont/fma/fma72655', 'http://purl.obolibrary.org/obo/UBERON_0002080', 'http://purl.obolibrary.org/obo/UBERON_0002094'],
        ...
        },
        {
          ...
          rui_location: {
            ...
            '@type': 'SpatialEntity',
            ccf_annotations: ['http://purl.obolibrary.org/obo/UBERON_0001156', 'http://purl.obolibrary.org/obo/UBERON_0001157', 'http://purl.obolibrary.org/obo/UBERON_0001159', 'http://purl.obolibrary.org/obo/UBERON_0001154', 'http://purl.obolibrary.org/obo/UBERON_0001158', 'http://purl.obolibrary.org/obo/UBERON_0001052'],
