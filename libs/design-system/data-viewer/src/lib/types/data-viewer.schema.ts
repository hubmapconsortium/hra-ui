...
export const ViewerFileSchema = z
  .object({
    label: z.string(),
    url: z.string().url(),
  })
...
export const ViewerCardSchema = z
  .object({
    label: z.string(),
...
export const ViewerOrganDataSchema = z
  .object({
    label: z.string(),
...
export const ReleaseVersionDataSchema = z
  .object({
    version: z.string(),
    label: z.string(),
    date: z.string(),
...
export const DataViewerVariantSchema = z.enum(['ftu', '3d-organ']).meta({ id: 'DataViewerVariant' });
