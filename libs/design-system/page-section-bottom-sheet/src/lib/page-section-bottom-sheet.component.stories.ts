...
import { PageSectionBottomSheetService, PageSectionData } from '../';
...
class PageSectionBottomSheetDemoComponent {
  readonly variant = input.required<'page-section' | 'page-sections'>();
  readonly tagline = input<string>('');
  readonly content = input<string>('');
  readonly sections = input<PageSectionData[]>([]);

  private readonly service = inject(PageSectionBottomSheetService);
...
const meta: Meta<PageSectionBottomSheetDemoComponent> = {
  component: PageSectionBottomSheetDemoComponent,
  title: 'Design System/Page Section Bottom Sheet',
  argTypes: {
    variant: {
      control: 'select',
      options: ['page-section', 'page-sections'],
...
type Story = StoryObj<PageSectionBottomSheetDemoComponent>;

export const SinglePageSection: Story = {
  args: {
...
export const MultiplePageSections: Story = {
  args: {
