...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, MatSidenavModule, AppsCardComponent, MatIconModule, MatButtonModule],
  templateUrl: './apps-sidenav.component.html',
  styleUrl: './apps-sidenav.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class AppsSidenavComponent {
  data = [
    {
      category: 'About',
      cards: [
