...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.11", ngImport: i0, type: AppLabelComponent, decorators: [{
        ...
        }], propDecorators: { tagline: [{ type: i0.Input, args: [{ isSignal: true, alias: "tagline", required: true }] }], logo: [{ type: i0.Input, args: [{ isSignal: true, alias: "logo", required: true }] }], appStatus: [{ type: i0.Input, args: [{ isSignal: true, alias: "appStatus", required: false }] }] } });
