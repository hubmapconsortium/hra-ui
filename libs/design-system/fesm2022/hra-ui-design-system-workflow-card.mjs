...
class WorkflowCardActionsComponent {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: WorkflowCardActionsComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.1.5", type: WorkflowCardActionsComponent, isStandalone: true, selector: "hra-workflow-card-actions", ngImport: i0, template: '<ng-content />', isInline: true, styles: [":host{display:flex;gap:.75rem}\n"], changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: WorkflowCardActionsComponent, decorators: [{
            type: Component,
...
class WorkflowCardExtraComponent {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: WorkflowCardExtraComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "21.1.5", type: WorkflowCardExtraComponent, isStandalone: true, selector: "hra-workflow-card-extra", ngImport: i0, template: '<ng-content />', isInline: true, styles: [":host{display:flex;gap:.75rem}\n"], changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: WorkflowCardExtraComponent, decorators: [{
            type: Component,
...
class WorkflowCardModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: WorkflowCardModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.1.5", ngImport: i0, type: WorkflowCardModule, imports: [WorkflowCardComponent, WorkflowCardActionsComponent, WorkflowCardExtraComponent], exports: [WorkflowCardComponent, WorkflowCardActionsComponent, WorkflowCardExtraComponent] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: WorkflowCardModule, imports: [WorkflowCardComponent] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: WorkflowCardModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: COMPONENTS,
                    exports: COMPONENTS,
