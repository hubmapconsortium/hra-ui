...
class WorkflowCardActionsComponent {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: WorkflowCardActionsComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.9", type: WorkflowCardActionsComponent, isStandalone: true, selector: "hra-workflow-card-actions", ngImport: i0, template: '<ng-content></ng-content>', isInline: true, styles: [":host{display:flex;gap:.75rem}\n"], changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
...
class WorkflowCardExtraComponent {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: WorkflowCardExtraComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.9", type: WorkflowCardExtraComponent, isStandalone: true, selector: "hra-workflow-card-extra", ngImport: i0, template: '<ng-content></ng-content>', isInline: true, styles: [":host{display:flex;gap:.75rem}\n"], changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
...
class WorkflowCardModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: WorkflowCardModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "20.3.9", ngImport: i0, type: WorkflowCardModule, imports: [WorkflowCardComponent, WorkflowCardActionsComponent, WorkflowCardExtraComponent], exports: [WorkflowCardComponent, WorkflowCardActionsComponent, WorkflowCardExtraComponent] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: WorkflowCardModule, imports: [WorkflowCardComponent] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: WorkflowCardModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: COMPONENTS,
                    exports: COMPONENTS,
