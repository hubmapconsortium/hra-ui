...
class NavigationButtonDescriptionDirective {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: NavigationButtonDescriptionDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.1.5", type: NavigationButtonDescriptionDirective, isStandalone: true, selector: "[hraNavigationButtonDescription]", host: { classAttribute: "supporting-text" }, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: NavigationButtonDescriptionDirective, decorators: [{
            type: Directive,
            args: [{
...
class NavigationButtonTaglineDirective {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: NavigationButtonTaglineDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.1.5", type: NavigationButtonTaglineDirective, isStandalone: true, selector: "[hraNavigationButtonTagline]", host: { classAttribute: "label" }, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: NavigationButtonTaglineDirective, decorators: [{
            type: Directive,
            args: [{
...
class NavigationIconDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: NavigationIconDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.1.0", version: "21.1.5", type: NavigationIconDirective, isStandalone: true, selector: "[hraNavigationIcon]", inputs: { hraNavigationIcon: { classPropertyName: "hraNavigationIcon", publicName: "hraNavigationIcon", isSignal: true, isRequired: false, transformFunction: null } }, host: { properties: { "class.leading-icon": "hraNavigationIcon() === \"leading\"", "class.trailing-icon": "hraNavigationIcon() !== \"leading\"" } }, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: NavigationIconDirective, decorators: [{
            type: Directive,
            args: [{
