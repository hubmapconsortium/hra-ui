...
class TextHyperlinkDirective {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.3", ngImport: i0, type: TextHyperlinkDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "20.3.3", type: TextHyperlinkDirective, isStandalone: true, selector: "a[hraHyperlink]", host: { classAttribute: "hra-text-hyperlink" }, hostDirectives: [{ directive: i1.ClickEventDirective, inputs: ["hraClickEvent", "hraHyperlink"] }], ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.3", ngImport: i0, type: TextHyperlinkDirective, decorators: [{
            type: Directive,
            args: [{
