...
class GalleryGridItemDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: GalleryGridItemDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.1.0", version: "20.3.15", type: GalleryGridItemDirective, isStandalone: true, selector: "[hraGalleryGridItem]", inputs: { hraGalleryGridItemOf: { classPropertyName: "hraGalleryGridItemOf", publicName: "hraGalleryGridItemOf", isSignal: true, isRequired: false, transformFunction: null } }, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: GalleryGridItemDirective, decorators: [{
            type: Directive,
            args: [{
...
class GalleryGridComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: GalleryGridComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "20.3.15", type: GalleryGridComponent, isStandalone: true, selector: "hra-gallery-grid", inputs: { dataSource: { classPropertyName: "dataSource", publicName: "dataSource", isSignal: true, isRequired: true, transformFunction: null } }, queries: [{ propertyName: "itemTemplate", first: true, predicate: GalleryGridItemDirective, descendants: true, read: GalleryGridItemDirective, isSignal: true }], ngImport: i0, template: "@if (itemTemplate()) {\n  @for (item of items(); track $index) {\n    <ng-container *ngTemplateOutlet=\"itemTemplate().templateRef; context: { $implicit: item, index: $index }\" />\n  }\n}\n", styles: [":host{display:grid;grid-template-columns:repeat(auto-fill,minmax(16.25rem,1fr));gap:1.5rem;justify-items:center}\n"], dependencies: [{ kind: "directive", type: NgTemplateOutlet, selector: "[ngTemplateOutlet]", inputs: ["ngTemplateOutletContext", "ngTemplateOutlet", "ngTemplateOutletInjector"] }], changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: GalleryGridComponent, decorators: [{
            type: Component,
