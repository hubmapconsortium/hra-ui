...
import { input, ChangeDetectionStrategy, Component, output, signal, effect } from '@angular/core';
...
class NavigationCategoryComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: NavigationCategoryComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "21.1.5", type: NavigationCategoryComponent, isStandalone: true, selector: "hra-navigation-category", inputs: { navigationCategory: { classPropertyName: "navigationCategory", publicName: "navigationCategory", isSignal: true, isRequired: true, transformFunction: null }, expanded: { classPropertyName: "expanded", publicName: "expanded", isSignal: true, isRequired: false, transformFunction: null } }, outputs: { expandedChange: "expandedChange" }, ngImport: i0, template: "<mat-expansion-panel\n  hraFeature=\"navigation-category-expansion\"\n  class=\"category\"\n  [hraClickEvent]=\"{\n    label: navigationCategory().label,\n    action: expanded() ? 'collapse' : 'expand',\n  }\"\n  [expanded]=\"expanded()\"\n  (expandedChange)=\"expandedChange.emit($event)\"\n>\n  <mat-expansion-panel-header class=\"header\">\n    <mat-icon>{{ navigationCategory().icon }}</mat-icon>\n    <div>{{ navigationCategory().label }}</div>\n  </mat-expansion-panel-header>\n\n  <div matExpansionPanelContent>\n    @for (navigationItem of navigationCategory().children; track navigationItem) {\n      <hra-navigation-item [navigationItem]=\"navigationItem\" />\n    }\n  </div>\n</mat-expansion-panel>\n", styles: [":host{display:block;--hra-navigation-item-padding-left: 2.25rem}:host ::ng-deep .mat-expansion-panel-body{padding:0}:host{--mat-expansion-container-shape: var(--mat-sys-corner-none);--mat-expansion-container-background-color: transparent;--mat-expansion-header-collapsed-state-height: 1.5rem;--mat-expansion-header-expanded-state-height: 1.5rem;--mat-expansion-header-hover-state-layer-color: rgb(from var(--mat-sys-secondary) r g b/8%);--mat-expansion-header-text-font: var(--mat-sys-label-large-font);--mat-expansion-header-text-size: var(--mat-sys-label-large-size);--mat-expansion-header-text-weight: var(--mat-sys-label-large-weight);--mat-expansion-header-text-line-height: var(--mat-sys-label-large-line-height);--mat-expansion-header-text-tracking: var(--mat-sys-label-large-tracking)}:host .category{box-shadow:none;margin:.5rem 0}:host .category .header{border-radius:.5rem;padding:.5rem 1rem}:host .category .header ::ng-deep .mat-content{align-items:center;gap:.75rem}:host .category .header{font:var(--mat-sys-label-medium);letter-spacing:var(--mat-sys-label-medium-tracking)}\n"], dependencies: [{ kind: "ngmodule", type: CommonModule }, { kind: "ngmodule", type: MatExpansionModule }, { kind: "component", type: i1$1.MatExpansionPanel, selector: "mat-expansion-panel", inputs: ["hideToggle", "togglePosition"], outputs: ["afterExpand", "afterCollapse"], exportAs: ["matExpansionPanel"] }, { kind: "component", type: i1$1.MatExpansionPanelHeader, selector: "mat-expansion-panel-header", inputs: ["expandedHeight", "collapsedHeight", "tabIndex"] }, { kind: "ngmodule", type: MatIconModule }, { kind: "component", type: i1.MatIcon, selector: "mat-icon", inputs: ["color", "inline", "svgIcon", "fontSet", "fontIcon"], exportAs: ["matIcon"] }, { kind: "component", type: NavigationItemComponent, selector: "hra-navigation-item", inputs: ["navigationItem"] }, { kind: "ngmodule", type: HraCommonModule }, { kind: "directive", type: i2.ClickEventDirective, selector: "[hraClickEvent]", inputs: ["hraClickEvent", "hraClickEventTriggerOn", "hraClickEventDisabled"], exportAs: ["hraClickEvent"] }, { kind: "directive", type: i2.FeatureDirective, selector: "[hraFeature]", inputs: ["hraFeature"] }], changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: NavigationCategoryComponent, decorators: [{
            type: Component,
        ...
        }], propDecorators: { navigationCategory: [{ type: i0.Input, args: [{ isSignal: true, alias: "navigationCategory", required: true }] }], expanded: [{ type: i0.Input, args: [{ isSignal: true, alias: "expanded", required: false }] }], expandedChange: [{ type: i0.Output, args: ["expandedChange"] }] } });
...
class SiteNavigationComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: SiteNavigationComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "21.1.5", type: SiteNavigationComponent, isStandalone: true, selector: "hra-site-navigation", inputs: { navigationMenu: { classPropertyName: "navigationMenu", publicName: "navigationMenu", isSignal: true, isRequired: false, transformFunction: null } }, ngImport: i0, template: "<ng-scrollbar>\n  <div class=\"scrollbar-container\">\n    <div class=\"heading\">\n      <div class=\"tagline\">Help & Documentation</div>\n      <div class=\"description\">\n        Documentation, guides, and standard operating procedures for Human Reference Atlas usage.\n      </div>\n    </div>\n\n    <mat-divider />\n\n    <div class=\"content\">\n      <mat-nav-list>\n        @for (navMenuItem of navigationMenu(); track navMenuItem) {\n          @if (navMenuItem.type === 'category') {\n            <hra-navigation-category\n              [navigationCategory]=\"navMenuItem\"\n              [expanded]=\"expandedCategory() === navMenuItem.label\"\n              (expandedChange)=\"changeExpandedCategory($event, navMenuItem.label)\"\n            />\n          } @else if (navMenuItem.type === 'item') {\n            <hra-navigation-item [navigationItem]=\"navMenuItem\" />\n          }\n          <mat-divider />\n        }\n      </mat-nav-list>\n    </div>\n  </div>\n</ng-scrollbar>\n", styles: [":host{display:block;background-color:var(--mat-sys-surface-container-low);border-right:.0625rem solid var(--mat-sys-outline);height:calc(100vh - 4.5rem);position:sticky;top:var(--hra-site-navigation-top-offset, 4.5rem);width:20rem}:host .scrollbar-container{padding:3rem 1rem}:host mat-nav-list{padding:0}:host{--mat-divider-color: var(--mat-sys-outline-variant);--mat-list-active-indicator-color: rgb(from var(--mat-sys-tertiary) r g b/20%);--mat-list-list-item-label-text-color: var(--mat-sys-primary);--mat-list-list-item-hover-label-text-color: var(--mat-sys-tertiary-fixed);--mat-list-list-item-hover-state-layer-color: var(--mat-sys-on-tertiary-fixed);--mat-list-list-item-hover-state-layer-opacity: 8%;--mat-list-list-item-hover-leading-icon-color: var(--mat-sys-tertiary-fixed)}:host .heading{padding:0 .75rem}:host .heading .tagline{color:var(--mat-sys-secondary);margin-bottom:8px;font:var(--mat-sys-title-small);letter-spacing:var(--mat-sys-title-small-tracking)}:host .heading .description{color:var(--mat-sys-primary);margin-bottom:1.5rem;font:var(--mat-sys-body-medium);letter-spacing:var(--mat-sys-body-medium-tracking)}:host .content{margin-top:.5rem}\n"], dependencies: [{ kind: "ngmodule", type: HraCommonModule }, { kind: "ngmodule", type: MatIconModule }, { kind: "ngmodule", type: ButtonsModule }, { kind: "component", type: MatDivider, selector: "mat-divider", inputs: ["vertical", "inset"] }, { kind: "ngmodule", type: MatListModule }, { kind: "component", type: i1$2.MatNavList, selector: "mat-nav-list", exportAs: ["matNavList"] }, { kind: "ngmodule", type: MatExpansionModule }, { kind: "ngmodule", type: MatButtonModule }, { kind: "ngmodule", type: RouterModule }, { kind: "component", type: NavigationCategoryComponent, selector: "hra-navigation-category", inputs: ["navigationCategory", "expanded"], outputs: ["expandedChange"] }, { kind: "component", type: NavigationItemComponent, selector: "hra-navigation-item", inputs: ["navigationItem"] }, { kind: "component", type: NgScrollbar, selector: "ng-scrollbar:not([externalViewport]), [ngScrollbar]", exportAs: ["ngScrollbar"] }, { kind: "ngmodule", type: ScrollingModule }], changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: SiteNavigationComponent, decorators: [{
            type: Component,
        ...
        }], ctorParameters: () => [], propDecorators: { navigationMenu: [{ type: i0.Input, args: [{ isSignal: true, alias: "navigationMenu", required: false }] }] } });
