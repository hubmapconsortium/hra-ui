...
class ViewOutletDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.3", ngImport: i0, type: ViewOutletDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.1.0", version: "20.3.3", type: ViewOutletDirective, isStandalone: true, selector: "[hraViewOutlet]", inputs: { viewRef: { classPropertyName: "viewRef", publicName: "hraViewOutlet", isSignal: true, isRequired: false, transformFunction: null } }, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.3", ngImport: i0, type: ViewOutletDirective, decorators: [{
            type: Directive,
            args: [{
...
class FullscreenActionsComponent {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.3", ngImport: i0, type: FullscreenActionsComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.3", type: FullscreenActionsComponent, isStandalone: true, selector: "hra-fullscreen-actions", ngImport: i0, template: `<ng-content></ng-content>`, isInline: true, styles: [":host{display:flex;width:100%;height:100%;flex-direction:row;align-items:center}\n"], changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.3", ngImport: i0, type: FullscreenActionsComponent, decorators: [{
            type: Component,
...
class FullscreenPortalContentComponent {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.3", ngImport: i0, type: FullscreenPortalContentComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.3", type: FullscreenPortalContentComponent, isStandalone: true, selector: "hra-fullscreen-portal-content", ngImport: i0, template: `<ng-content></ng-content>`, isInline: true, styles: [":host{width:100%;height:100%}\n"], changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.3", ngImport: i0, type: FullscreenPortalContentComponent, decorators: [{
            type: Component,
