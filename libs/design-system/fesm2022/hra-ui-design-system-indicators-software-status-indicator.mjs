...
class SoftwareStatusSizeDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.11", ngImport: i0, type: SoftwareStatusSizeDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.1.0", version: "20.3.11", type: SoftwareStatusSizeDirective, isStandalone: true, selector: "[hraSoftwareStatusSize]", inputs: { size: { classPropertyName: "size", publicName: "hraSoftwareStatusSize", isSignal: true, isRequired: true, transformFunction: null } }, host: { properties: { "style.font": "font()" } }, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.11", ngImport: i0, type: SoftwareStatusSizeDirective, decorators: [{
            type: Directive,
            args: [{
