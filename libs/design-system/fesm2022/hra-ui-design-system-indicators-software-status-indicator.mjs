...
class SoftwareStatusSizeDirective {
    ...
    size = input.required({ ...(ngDevMode ? { debugName: "size" } : {}), alias: 'hraSoftwareStatusSize' });
    /** Font */
    font = computed(() => STATUS_FONTS[this.size()], ...(ngDevMode ? [{ debugName: "font" }] : []));
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: SoftwareStatusSizeDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.1.0", version: "21.1.5", type: SoftwareStatusSizeDirective, isStandalone: true, selector: "[hraSoftwareStatusSize]", inputs: { size: { classPropertyName: "size", publicName: "hraSoftwareStatusSize", isSignal: true, isRequired: true, transformFunction: null } }, host: { properties: { "style.font": "font()" } }, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: SoftwareStatusSizeDirective, decorators: [{
            type: Directive,
            args: [{
