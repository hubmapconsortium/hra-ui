...
class HubmapMenuGroupDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: HubmapMenuGroupDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.1.5", type: HubmapMenuGroupDirective, isStandalone: true, selector: "ng-template[hraHubmapMenuGroup]", ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: HubmapMenuGroupDirective, decorators: [{
            type: Directive,
            args: [{
...
class HubmapMenuItemDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: HubmapMenuItemDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.1.5", type: HubmapMenuItemDirective, isStandalone: true, selector: "ng-template[hraHubmapMenuItem]", ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: HubmapMenuItemDirective, decorators: [{
            type: Directive,
            args: [{
...
class MenuGroupDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: MenuGroupDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.1.5", type: MenuGroupDirective, isStandalone: true, selector: "ng-template[hraMenuGroup]", ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: MenuGroupDirective, decorators: [{
            type: Directive,
            args: [{
...
class MenuItemDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: MenuItemDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.1.5", type: MenuItemDirective, isStandalone: true, selector: "ng-template[hraMenuItem]", ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: MenuItemDirective, decorators: [{
            type: Directive,
            args: [{
...
class MenuSubGroupDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: MenuSubGroupDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.1.5", type: MenuSubGroupDirective, isStandalone: true, selector: "ng-template[hraMenuSubGroup]", ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: MenuSubGroupDirective, decorators: [{
            type: Directive,
            args: [{
...
class DesktopMenuComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: DesktopMenuComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "21.1.5", type: DesktopMenuComponent, isStandalone: true, selector: "hra-desktop-menu", inputs: { menu: { classPropertyName: "menu", publicName: "menu", isSignal: true, isRequired: true, transformFunction: null } }, ngImport: i0, template: "<ng-scrollbar>\n  @let typed = typedMenu();\n  @if (typed.type === 'menu') {\n    <hra-menu-content variant=\"desktop\" [menu]=\"typed.menu\" />\n  } @else {\n    <hra-hubmap-menu-content [menu]=\"typed.menu\" />\n  }\n</ng-scrollbar>\n", styles: [":host{display:block;max-width:26.75rem;padding:.75rem 0;border-radius:.5rem;background-color:var(--mat-sys-surface-dim);box-shadow:0 .3125rem 1rem rgb(from var(--mat-sys-secondary) r g b/20%)}\n"], dependencies: [{ kind: "ngmodule", type: CommonModule }, { kind: "ngmodule", type: ScrollingModule }, { kind: "component", type: i1$2.NgScrollbar, selector: "ng-scrollbar:not([externalViewport]), [ngScrollbar]", exportAs: ["ngScrollbar"] }, { kind: "component", type: HubmapMenuContentComponent, selector: "hra-hubmap-menu-content", inputs: ["menu"] }, { kind: "component", type: MenuContentComponent, selector: "hra-menu-content", inputs: ["variant", "menu"] }], changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: DesktopMenuComponent, decorators: [{
            type: Component,
		...
		items: [
			{
				...
				items: [
					...
					},
					{
						type: "item",
						label: "Visual Assets",
						url: "https://docs.humanatlas.io/visual-assets"
					}
				]
			}
		]
...
class HeaderComponent {
    ...
    mobileMenuOverlay = viewChild('mobileMenuOverlay', { ...(ngDevMode ? { debugName: "mobileMenuOverlay" } : {}), read: CdkConnectedOverlay });
