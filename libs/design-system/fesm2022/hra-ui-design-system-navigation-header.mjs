...
import { Directive, input, ChangeDetectionStrategy, Component, inject, computed, model, ElementRef, signal, viewChild, effect } from '@angular/core';
...
import * as i7 from '@hra-ui/common';
...
import * as i6 from '@hra-ui/design-system/buttons/button';
...
class HubmapMenuGroupDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.7", ngImport: i0, type: HubmapMenuGroupDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "20.3.7", type: HubmapMenuGroupDirective, isStandalone: true, selector: "ng-template[hraHubmapMenuGroup]", ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.7", ngImport: i0, type: HubmapMenuGroupDirective, decorators: [{
            type: Directive,
            args: [{
...
class HubmapMenuItemDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.7", ngImport: i0, type: HubmapMenuItemDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "20.3.7", type: HubmapMenuItemDirective, isStandalone: true, selector: "ng-template[hraHubmapMenuItem]", ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.7", ngImport: i0, type: HubmapMenuItemDirective, decorators: [{
            type: Directive,
            args: [{
...
class MenuGroupDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.7", ngImport: i0, type: MenuGroupDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "20.3.7", type: MenuGroupDirective, isStandalone: true, selector: "ng-template[hraMenuGroup]", ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.7", ngImport: i0, type: MenuGroupDirective, decorators: [{
            type: Directive,
            args: [{
...
class MenuItemDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.7", ngImport: i0, type: MenuItemDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "20.3.7", type: MenuItemDirective, isStandalone: true, selector: "ng-template[hraMenuItem]", ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.7", ngImport: i0, type: MenuItemDirective, decorators: [{
            type: Directive,
            args: [{
...
class MenuSubGroupDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.7", ngImport: i0, type: MenuSubGroupDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "20.3.7", type: MenuSubGroupDirective, isStandalone: true, selector: "ng-template[hraMenuSubGroup]", ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.7", ngImport: i0, type: MenuSubGroupDirective, decorators: [{
            type: Directive,
            args: [{
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.7", ngImport: i0, type: MenuContentComponent, decorators: [{
        ...
        }], propDecorators: { variant: [{ type: i0.Input, args: [{ isSignal: true, alias: "variant", required: true }] }], menu: [{ type: i0.Input, args: [{ isSignal: true, alias: "menu", required: true }] }], baseUrl: [{ type: i0.Input, args: [{ isSignal: true, alias: "baseUrl", required: true }] }] } });
...
class DesktopMenuComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.7", ngImport: i0, type: DesktopMenuComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "20.3.7", type: DesktopMenuComponent, isStandalone: true, selector: "hra-desktop-menu", inputs: { menu: { classPropertyName: "menu", publicName: "menu", isSignal: true, isRequired: true, transformFunction: null }, baseUrl: { classPropertyName: "baseUrl", publicName: "baseUrl", isSignal: true, isRequired: true, transformFunction: null } }, ngImport: i0, template: "<ng-scrollbar>\n  @let typed = typedMenu();\n  @if (typed.type === 'menu') {\n    <hra-menu-content variant=\"desktop\" [menu]=\"typed.menu\" [baseUrl]=\"baseUrl()\" />\n  } @else {\n    <hra-hubmap-menu-content [menu]=\"typed.menu\" />\n  }\n</ng-scrollbar>\n", styles: [":host{display:block;max-width:26.75rem;padding:.75rem 0;border-radius:.5rem;background-color:var(--mat-sys-surface-dim);box-shadow:0 .3125rem 1rem rgb(from var(--mat-sys-secondary) r g b/20%)}\n"], dependencies: [{ kind: "ngmodule", type: CommonModule }, { kind: "ngmodule", type: ScrollingModule }, { kind: "component", type: i1$2.NgScrollbar, selector: "ng-scrollbar:not([externalViewport])", exportAs: ["ngScrollbar"] }, { kind: "component", type: HubmapMenuContentComponent, selector: "hra-hubmap-menu-content", inputs: ["menu"] }, { kind: "component", type: MenuContentComponent, selector: "hra-menu-content", inputs: ["variant", "menu", "baseUrl"] }], changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.7", ngImport: i0, type: DesktopMenuComponent, decorators: [{
            type: Component,
        ...
        }], propDecorators: { menu: [{ type: i0.Input, args: [{ isSignal: true, alias: "menu", required: true }] }], baseUrl: [{ type: i0.Input, args: [{ isSignal: true, alias: "baseUrl", required: true }] }] } });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.7", ngImport: i0, type: MobileMenuComponent, decorators: [{
        ...
        }], propDecorators: { hubmapMenu: [{ type: i0.Input, args: [{ isSignal: true, alias: "hubmapMenu", required: true }] }], menus: [{ type: i0.Input, args: [{ isSignal: true, alias: "menus", required: true }] }], baseUrl: [{ type: i0.Input, args: [{ isSignal: true, alias: "baseUrl", required: true }] }] } });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.7", ngImport: i0, type: HeaderComponent, decorators: [{
        ...
        }], ctorParameters: () => [], propDecorators: { cta: [{ type: i0.Input, args: [{ isSignal: true, alias: "cta", required: false }] }], hubmapMenu: [{ type: i0.Input, args: [{ isSignal: true, alias: "hubmapMenu", required: false }] }], menus: [{ type: i0.Input, args: [{ isSignal: true, alias: "menus", required: false }] }], baseUrl: [{ type: i0.Input, args: [{ isSignal: true, alias: "baseUrl", required: false }] }], breadcrumbs: [{ type: i0.Input, args: [{ isSignal: true, alias: "breadcrumbs", required: false }] }], progress: [{ type: i0.Input, args: [{ isSignal: true, alias: "progress", required: false }] }], ctaDismissed: [{ type: i0.Input, args: [{ isSignal: true, alias: "ctaDismissed", required: false }] }, { type: i0.Output, args: ["ctaDismissedChange"] }], mobileMenuOrigin: [{ type: i0.ViewChild, args: ['mobileMenuOrigin', { ...{ read: ElementRef }, isSignal: true }] }], desktopMenuOrigin: [{ type: i0.ViewChild, args: ['desktopMenuOrigin', { ...{ read: ElementRef }, isSignal: true }] }], mobileMenuOverlay: [{ type: i0.ViewChild, args: ['mobileMenuOverlay', { ...{ read: CdkConnectedOverlay }, isSignal: true }] }] } });
