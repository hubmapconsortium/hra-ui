...
class FilterMenuComponent {
    ...
    enableTotalCount = input(false, ...(ngDevMode ? [{ debugName: "enableTotalCount" }] : []));
    ...
    _addTotalCounts(filterCategories) {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: FilterMenuComponent, decorators: [{
        ...
        }], propDecorators: { tagline: [{ type: i0.Input, args: [{ isSignal: true, alias: "tagline", required: false }] }], description: [{ type: i0.Input, args: [{ isSignal: true, alias: "description", required: false }] }], enableClose: [{ type: i0.Input, args: [{ isSignal: true, alias: "enableClose", required: false }] }], enableTotalCount: [{ type: i0.Input, args: [{ isSignal: true, alias: "enableTotalCount", required: false }] }], filters: [{ type: i0.Input, args: [{ isSignal: true, alias: "filters", required: true }] }, { type: i0.Output, args: ["filtersChange"] }], closeClick: [{ type: i0.Output, args: ["closeClick"] }] } });
