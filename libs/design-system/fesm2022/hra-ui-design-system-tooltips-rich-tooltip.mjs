...
class RichTooltipContextDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: RichTooltipContextDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "20.3.9", type: RichTooltipContextDirective, isStandalone: true, selector: "ng-template[hraRichTooltipContext]", ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: RichTooltipContextDirective, decorators: [{
            type: Directive,
            args: [{
...
class RichTooltipTaglineComponent {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: RichTooltipTaglineComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.9", type: RichTooltipTaglineComponent, isStandalone: true, selector: "hra-rich-tooltip-tagline", ngImport: i0, template: '<ng-content />', isInline: true, changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: RichTooltipTaglineComponent, decorators: [{
            type: Component,
            args: [{
...
class RichTooltipContentComponent {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: RichTooltipContentComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.9", type: RichTooltipContentComponent, isStandalone: true, selector: "hra-rich-tooltip-content", ngImport: i0, template: '<ng-content />', isInline: true, changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: RichTooltipContentComponent, decorators: [{
            type: Component,
            args: [{
...
class RichTooltipActionsComponent {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: RichTooltipActionsComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.9", type: RichTooltipActionsComponent, isStandalone: true, selector: "hra-rich-tooltip-actions", ngImport: i0, template: '<ng-content />', isInline: true, changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: RichTooltipActionsComponent, decorators: [{
            type: Component,
            args: [{
...
class RichTooltipCloseDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: RichTooltipCloseDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "20.3.9", type: RichTooltipCloseDirective, isStandalone: true, selector: "[hraRichTooltipClose]", host: { listeners: { "click": "controller?.close()" } }, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: RichTooltipCloseDirective, decorators: [{
            type: Directive,
            args: [{
...
class RichTooltipDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: RichTooltipDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.1.0", version: "20.3.9", type: RichTooltipDirective, isStandalone: true, selector: "[hraRichTooltip]", inputs: { customContainer: { classPropertyName: "customContainer", publicName: "hraRichTooltip", isSignal: true, isRequired: false, transformFunction: null }, tagline: { classPropertyName: "tagline", publicName: "hraRichTooltipTagline", isSignal: true, isRequired: false, transformFunction: null }, description: { classPropertyName: "description", publicName: "hraRichTooltipDescription", isSignal: true, isRequired: false, transformFunction: null }, actionText: { classPropertyName: "actionText", publicName: "hraRichTooltipActionText", isSignal: true, isRequired: false, transformFunction: null }, positions: { classPropertyName: "positions", publicName: "hraRichTooltipPositions", isSignal: true, isRequired: false, transformFunction: null } }, outputs: { actionClick: "hraRichTooltipActionClick" }, host: { listeners: { "click": "toggle()" } }, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: RichTooltipDirective, decorators: [{
            type: Directive,
            args: [{
...
class RichTooltipModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: RichTooltipModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "20.3.9", ngImport: i0, type: RichTooltipModule, imports: [RichTooltipDirective,
    ...
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: RichTooltipModule, imports: [RichTooltipContainerComponent] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.9", ngImport: i0, type: RichTooltipModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
