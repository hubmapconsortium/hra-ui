...
class TreeSizeDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: TreeSizeDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.1.0", version: "20.3.15", type: TreeSizeDirective, isStandalone: true, selector: "[hraTreeSize]", inputs: { size: { classPropertyName: "size", publicName: "hraTreeSize", isSignal: true, isRequired: true, transformFunction: null } }, host: { properties: { "style.--mat-tree-node-text-size.rem": "fontSize()", "style.--mat-tree-node-min-height.rem": "nodeHeight()", "style.--mat-icon-button-state-layer-size.rem": "nodeHeight()", "style.--mat-icon-button-icon-size.rem": "iconSize()" } }, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: TreeSizeDirective, decorators: [{
            type: Directive,
            args: [{
