...
class GalleryCardComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.7", ngImport: i0, type: GalleryCardComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "20.3.7", type: GalleryCardComponent, isStandalone: true, selector: "hra-gallery-card", inputs: { tagline: { classPropertyName: "tagline", publicName: "tagline", isSignal: true, isRequired: true, transformFunction: null }, imageSrc: { classPropertyName: "imageSrc", publicName: "imageSrc", isSignal: true, isRequired: true, transformFunction: null }, date: { classPropertyName: "date", publicName: "date", isSignal: true, isRequired: true, transformFunction: null }, link: { classPropertyName: "link", publicName: "link", isSignal: true, isRequired: true, transformFunction: null }, external: { classPropertyName: "external", publicName: "external", isSignal: true, isRequired: false, transformFunction: null }, tags: { classPropertyName: "tags", publicName: "tags", isSignal: true, isRequired: false, transformFunction: null } }, ngImport: i0, template: "<img class=\"image\" [attr.src]=\"imageSrc() | assetUrl\" alt=\"\" />\n<div class=\"content\">\n  <div class=\"date\">{{ date() }}</div>\n  <a\n    class=\"tagline-link\"\n    hraHyperlink\n    [href]=\"link()\"\n    [target]=\"external() ? '_blank' : '_self'\"\n    [rel]=\"external() ? 'noopener noreferrer' : null\"\n    [matTooltip]=\"tagline()\"\n  >\n    {{ tagline() }}\n  </a>\n  @if (tags().length > 0) {\n    <mat-chip-set class=\"tags\">\n      @for (tag of tags(); track tag) {\n        <mat-chip>{{ tag }}</mat-chip>\n      }\n    </mat-chip-set>\n  }\n</div>\n", styles: [":host{min-width:17rem;max-width:28rem}:host .image{width:100%;max-height:12.5rem;object-fit:cover;aspect-ratio:16/9}:host .content{display:flex;flex-direction:column;gap:.5rem;padding-top:1rem;min-height:6.875rem}:host .content .date{font:var(--mat-sys-label-medium);letter-spacing:var(--mat-sys-label-medium-tracking);color:var(--mat-sys-on-secondary-fixed)}:host .content .tagline-link{font:var(--mat-sys-title-medium);letter-spacing:var(--mat-sys-title-medium-tracking);overflow:hidden;text-overflow:ellipsis;display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:2;color:var(--mat-sys-tertiary);text-decoration:underline;cursor:pointer}@supports (line-clamp: 2){:host .content .tagline-link{display:block;line-clamp:2}}:host .content .tags{padding-top:1.25rem}\n"], dependencies: [{ kind: "ngmodule", type: MatChipsModule }, { kind: "component", type: i1.MatChip, selector: "mat-basic-chip, [mat-basic-chip], mat-chip, [mat-chip]", inputs: ["role", "id", "aria-label", "aria-description", "value", "color", "removable", "highlighted", "disableRipple", "disabled"], outputs: ["removed", "destroyed"], exportAs: ["matChip"] }, { kind: "component", type: i1.MatChipSet, selector: "mat-chip-set", inputs: ["disabled", "role", "tabIndex"] }, { kind: "ngmodule", type: MatTooltipModule }, { kind: "directive", type: i2.MatTooltip, selector: "[matTooltip]", inputs: ["matTooltipPosition", "matTooltipPositionAtOrigin", "matTooltipDisabled", "matTooltipShowDelay", "matTooltipHideDelay", "matTooltipTouchGestures", "matTooltip", "matTooltipClass"], exportAs: ["matTooltip"] }, { kind: "directive", type: TextHyperlinkDirective, selector: "a[hraHyperlink]" }, { kind: "pipe", type: AssetUrlPipe, name: "assetUrl" }], changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.7", ngImport: i0, type: GalleryCardComponent, decorators: [{
            type: Component,
            args: [{ selector: 'hra-gallery-card', imports: [AssetUrlPipe, MatChipsModule, MatTooltipModule, TextHyperlinkDirective], changeDetection: ChangeDetectionStrategy.OnPush, template: "<img class=\"image\" [attr.src]=\"imageSrc() | assetUrl\" alt=\"\" />\n<div class=\"content\">\n  <div class=\"date\">{{ date() }}</div>\n  <a\n    class=\"tagline-link\"\n    hraHyperlink\n    [href]=\"link()\"\n    [target]=\"external() ? '_blank' : '_self'\"\n    [rel]=\"external() ? 'noopener noreferrer' : null\"\n    [matTooltip]=\"tagline()\"\n  >\n    {{ tagline() }}\n  </a>\n  @if (tags().length > 0) {\n    <mat-chip-set class=\"tags\">\n      @for (tag of tags(); track tag) {\n        <mat-chip>{{ tag }}</mat-chip>\n      }\n    </mat-chip-set>\n  }\n</div>\n", styles: [":host{min-width:17rem;max-width:28rem}:host .image{width:100%;max-height:12.5rem;object-fit:cover;aspect-ratio:16/9}:host .content{display:flex;flex-direction:column;gap:.5rem;padding-top:1rem;min-height:6.875rem}:host .content .date{font:var(--mat-sys-label-medium);letter-spacing:var(--mat-sys-label-medium-tracking);color:var(--mat-sys-on-secondary-fixed)}:host .content .tagline-link{font:var(--mat-sys-title-medium);letter-spacing:var(--mat-sys-title-medium-tracking);overflow:hidden;text-overflow:ellipsis;display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:2;color:var(--mat-sys-tertiary);text-decoration:underline;cursor:pointer}@supports (line-clamp: 2){:host .content .tagline-link{display:block;line-clamp:2}}:host .content .tags{padding-top:1.25rem}\n"] }]
