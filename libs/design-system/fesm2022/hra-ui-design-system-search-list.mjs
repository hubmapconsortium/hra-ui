...
class SearchListComponent {
    ...
    disableSearch = input(false, { ...(ngDevMode ? { debugName: "disableSearch" } : {}), transform: booleanAttribute });
    /** Whether to disable the ripple effect for list items */
    disableRipple = input(false, { ...(ngDevMode ? { debugName: "disableRipple" } : {}), transform: booleanAttribute });
    /** All filter options */
