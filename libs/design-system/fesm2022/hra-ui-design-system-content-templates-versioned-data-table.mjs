...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: VersionedDataTableComponent, decorators: [{
        ...
        }], propDecorators: { label: [{ type: i0.Input, args: [{ isSignal: true, alias: "label", required: true }] }], items: [{ type: i0.Input, args: [{ isSignal: true, alias: "items", required: true }] }], selection: [{ type: i0.Input, args: [{ isSignal: true, alias: "selection", required: false }] }, { type: i0.Output, args: ["selectionChange"] }], columns: [{ type: i0.Input, args: [{ isSignal: true, alias: "columns", required: false }] }], variant: [{ type: i0.Input, args: [{ isSignal: true, alias: "variant", required: false }] }], enableSort: [{ type: i0.Input, args: [{ isSignal: true, alias: "enableSort", required: false }] }], verticalDividers: [{ type: i0.Input, args: [{ isSignal: true, alias: "verticalDividers", required: false }] }], hideVersionSelector: [{ type: i0.Input, args: [{ isSignal: true, alias: "hideVersionSelector", required: false }] }] } });
