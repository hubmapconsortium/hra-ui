...
class HraYoutubePlayerComponent {
    ...
    thumbnailUrl = computed(() => `https://img.youtube.com/vi/${this.videoId()}/maxresdefault.jpg`, ...(ngDevMode ? [{ debugName: "thumbnailUrl" }] : []));
    /** YouTube video URL */
