...
class MarkdownComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: MarkdownComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.1.0", version: "21.1.5", type: MarkdownComponent, isStandalone: true, selector: "hra-markdown", inputs: { data: { classPropertyName: "data", publicName: "data", isSignal: true, isRequired: false, transformFunction: null }, src: { classPropertyName: "src", publicName: "src", isSignal: true, isRequired: false, transformFunction: null } }, ngImport: i0, template: "<markdown\n  [data]=\"data()\"\n  [src]=\"src() ? (src()! | assetUrl) : undefined\"\n  (ready)=\"clearEventListeners(); attachEventListeners()\"\n/>\n", styles: [":host{display:block}:host markdown ::ng-deep :not(pre)>code{font:var(--mat-sys-code-medium);letter-spacing:var(--mat-sys-code-medium-tracking);background-color:var(--mat-sys-surface-container-high);border-radius:.25rem;-webkit-box-decoration-break:clone;box-decoration-break:clone;overflow-wrap:anywhere;padding:.125rem .25rem}:host markdown ::ng-deep p{margin:.75rem 0;line-height:1.6875rem}:host markdown ::ng-deep *:first-child{margin-top:0}\n"], dependencies: [{ kind: "ngmodule", type: CommonModule }, { kind: "component", type: MarkdownComponent$1, selector: "markdown, [markdown]", inputs: ["data", "src", "disableSanitizer", "inline", "clipboard", "clipboardButtonComponent", "clipboardButtonTemplate", "emoji", "katex", "katexOptions", "mermaid", "mermaidOptions", "lineHighlight", "line", "lineOffset", "lineNumbers", "start", "commandLine", "filterOutput", "host", "prompt", "output", "user"], outputs: ["error", "load", "ready"] }, { kind: "pipe", type: AssetUrlPipe, name: "assetUrl" }], changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: MarkdownComponent, decorators: [{
            type: Component,
