...
class FilterContainerComponent {
    ...
    totalCount = input(...(ngDevMode ? [undefined, { debugName: "totalCount" }] : []));
    /** Whether to show the info button with tooltip */
    showTooltip = input(false, { ...(ngDevMode ? { debugName: "showTooltip" } : {}), transform: booleanAttribute });
    ...
    enableDivider = input(false, { ...(ngDevMode ? { debugName: "enableDivider" } : {}), transform: booleanAttribute });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: FilterContainerComponent, decorators: [{
        ...
        }], propDecorators: { action: [{ type: i0.Input, args: [{ isSignal: true, alias: "action", required: true }] }], totalCount: [{ type: i0.Input, args: [{ isSignal: true, alias: "totalCount", required: false }] }], showTooltip: [{ type: i0.Input, args: [{ isSignal: true, alias: "showTooltip", required: false }] }], chips: [{ type: i0.Input, args: [{ isSignal: true, alias: "chips", required: false }] }, { type: i0.Output, args: ["chipsChange"] }], enableDivider: [{ type: i0.Input, args: [{ isSignal: true, alias: "enableDivider", required: false }] }], actionClick: [{ type: i0.Output, args: ["actionClick"] }] } });
