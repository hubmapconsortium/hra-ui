...
class CodeBlockComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: CodeBlockComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.1.0", version: "21.1.5", type: CodeBlockComponent, isStandalone: true, selector: "hra-code-block", inputs: { code: { classPropertyName: "code", publicName: "code", isSignal: true, isRequired: true, transformFunction: null }, language: { classPropertyName: "language", publicName: "language", isSignal: true, isRequired: true, transformFunction: null } }, ngImport: i0, template: "<ng-scrollbar>\n  <pre class=\"code-block-pre\">\n    <code [highlight]=\"code()\" [language]=\"language()\"></code>\n  </pre>\n</ng-scrollbar>\n", styles: [":host{display:flex;background-color:var(--mat-sys-surface-container);border:solid .0625rem var(--mat-sys-outline-variant);border-radius:.25rem;padding:.75rem;max-height:calc(100vh - 15rem)}:host ng-scrollbar{flex:1 1}:host .code-block-pre{font:var(--mat-sys-code-medium);letter-spacing:var(--mat-sys-code-medium-tracking);margin:0;text-align:left;display:flex;white-space:pre-wrap}:host .code-block-pre code{background-color:var(--mat-sys-surface-container)}\n"], dependencies: [{ kind: "ngmodule", type: CommonModule }, { kind: "ngmodule", type: HighlightModule }, { kind: "directive", type: i1.Highlight, selector: "[highlight]", inputs: ["highlight", "language", "ignoreIllegals"], outputs: ["highlighted"] }, { kind: "ngmodule", type: ScrollingModule }, { kind: "component", type: i2.NgScrollbar, selector: "ng-scrollbar:not([externalViewport]), [ngScrollbar]", exportAs: ["ngScrollbar"] }], changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: CodeBlockComponent, decorators: [{
            type: Component,
