...
class ContentButtonComponent {
    ...
    external = input(true, { ...(ngDevMode ? { debugName: "external" } : {}), transform: booleanAttribute });
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: ContentButtonComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "21.1.5", type: ContentButtonComponent, isStandalone: true, selector: "hra-content-button", inputs: { imageSrc: { classPropertyName: "imageSrc", publicName: "imageSrc", isSignal: true, isRequired: true, transformFunction: null }, date: { classPropertyName: "date", publicName: "date", isSignal: true, isRequired: true, transformFunction: null }, tagline: { classPropertyName: "tagline", publicName: "tagline", isSignal: true, isRequired: true, transformFunction: null }, tags: { classPropertyName: "tags", publicName: "tags", isSignal: true, isRequired: false, transformFunction: null }, link: { classPropertyName: "link", publicName: "link", isSignal: true, isRequired: true, transformFunction: null }, external: { classPropertyName: "external", publicName: "external", isSignal: true, isRequired: false, transformFunction: null } }, ngImport: i0, template: "<a mat-button class=\"content-button\" [hraLink]=\"link()\" [hraLinkExternal]=\"external()\">\n  <div class=\"header\">\n    <img class=\"image\" alt=\"\" [attr.src]=\"imageSrc() | assetUrl\" />\n  </div>\n\n  <div class=\"content\">\n    <span class=\"date\">{{ date() }}</span>\n    <span class=\"tagline\">{{ tagline() }}</span>\n    <mat-chip-set class=\"tags\">\n      @for (tag of tags(); track tag) {\n        <mat-chip class=\"tag\">{{ tag }}</mat-chip>\n      }\n    </mat-chip-set>\n  </div>\n</a>\n", styles: [":host{display:flex;flex-direction:column;overflow:hidden;width:100%;min-width:16.25rem;max-width:23.75rem;--mat-button-text-state-layer-color: var(--mat-sys-secondary);--mat-button-text-hover-state-layer-opacity: 0}:host .content-button{text-align:start;justify-content:start;height:fit-content;width:100%;padding:1rem;border:.0625rem solid var(--mat-sys-outline);border-radius:.75rem;background-color:var(--mat-sys-on-primary)}:host .content-button:hover .image,:host .content-button:focus-visible .image{max-width:13.5rem}:host .content-button:focus-visible{outline-color:var(--mat-sys-secondary)}:host .header{height:8.25rem}:host .header .image{width:100%;aspect-ratio:16/9;max-width:11.75rem;border-radius:.75rem;object-fit:cover;transition:.3s ease-in-out;background:var(--mat-sys-on-primary)}:host .content{display:flex;flex-direction:column;flex-grow:1}:host .content .date{color:var(--mat-sys-secondary);margin-bottom:.375rem;font:var(--mat-sys-label-medium);letter-spacing:var(--mat-sys-label-medium-tracking)}:host .content .tag{margin-top:0;margin-bottom:0;pointer-events:none}:host .content .tagline{min-height:3rem;color:var(--mat-sys-primary);margin-bottom:1rem;font:var(--mat-sys-label-large);letter-spacing:var(--mat-sys-label-large-tracking);overflow:hidden;text-overflow:ellipsis;display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:2}@supports (line-clamp: 2){:host .content .tagline{display:block;line-clamp:2}}\n"], dependencies: [{ kind: "ngmodule", type: HraCommonModule }, { kind: "ngmodule", type: MatChipsModule }, { kind: "component", type: i1.MatChip, selector: "mat-basic-chip, [mat-basic-chip], mat-chip, [mat-chip]", inputs: ["role", "id", "aria-label", "aria-description", "value", "color", "removable", "highlighted", "disableRipple", "disabled"], outputs: ["removed", "destroyed"], exportAs: ["matChip"] }, { kind: "component", type: i1.MatChipSet, selector: "mat-chip-set", inputs: ["disabled", "role", "tabIndex"] }, { kind: "ngmodule", type: ButtonsModule }, { kind: "component", type: i2.MatButton, selector: "    button[matButton], a[matButton], button[mat-button], button[mat-raised-button],    button[mat-flat-button], button[mat-stroked-button], a[mat-button], a[mat-raised-button],    a[mat-flat-button], a[mat-stroked-button]  ", inputs: ["matButton"], exportAs: ["matButton", "matAnchor"] }, { kind: "directive", type: LinkDirective, selector: "a[hraLink], area[hraLink]", inputs: ["hraLink", "hraLinkExternal", "hraLinkDownload"] }, { kind: "pipe", type: i3.AssetUrlPipe, name: "assetUrl" }], changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: ContentButtonComponent, decorators: [{
            type: Component,
