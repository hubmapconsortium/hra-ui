...
class ButtonToggleSizeDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: ButtonToggleSizeDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.1.0", version: "20.3.15", type: ButtonToggleSizeDirective, isStandalone: true, selector: "mat-button-toggle-group[hraButtonToggleSize]", inputs: { size: { classPropertyName: "size", publicName: "hraButtonToggleSize", isSignal: true, isRequired: true, transformFunction: null } }, host: { properties: { "class": "\"hra-button-toggle-size-\" + size()" } }, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: ButtonToggleSizeDirective, decorators: [{
            type: Directive,
            args: [{
