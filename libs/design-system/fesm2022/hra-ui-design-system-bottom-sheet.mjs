...
class BottomSheetComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: BottomSheetComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "21.1.5", type: BottomSheetComponent, isStandalone: true, selector: "hra-bottom-sheet", ngImport: i0, template: "<div class=\"sheet-header\" hraFeature=\"bottom-sheet\">\n  <button\n    hraFeature=\"close\"\n    hraClickEvent\n    mat-icon-button\n    class=\"close\"\n    aria-label=\"Close bottom sheet\"\n    (click)=\"close()\"\n  >\n    <mat-icon>close</mat-icon>\n  </button>\n</div>\n\n<ng-scrollbar hraScrollOverflowFade>\n  <div class=\"sheet-content\" tabindex=\"-1\" cdkFocusInitial>\n    @switch (data.variant) {\n      @case ('table') {\n        <hra-table [rows]=\"data.rows\" [columns]=\"data.columns\" [hideHeaders]=\"data.hideHeaders ?? false\" />\n      }\n\n      @case ('page-section') {\n        <hra-page-section [tagline]=\"data.tagline\">\n          @if (data.content) {\n            {{ data.content }}\n          }\n        </hra-page-section>\n      }\n\n      @case ('page-sections') {\n        <div class=\"multiple-sections\">\n          @for (section of data.sections; track section.tagline) {\n            <div class=\"section-item\">\n              <hra-page-section [tagline]=\"section.tagline\">\n                @if (section.content) {\n                  {{ section.content }}\n                }\n              </hra-page-section>\n            </div>\n          }\n        </div>\n      }\n    }\n  </div>\n</ng-scrollbar>\n", styles: [":host{display:block;height:100%;overflow:hidden}:host .sheet-header{display:flex;flex-direction:row;justify-content:flex-end}:host .sheet-header .close{margin-bottom:.5rem}:host hra-table{height:auto;max-height:min(22.6rem,80vh - 3rem - 1rem)}:host .multiple-sections{display:flex;flex-direction:column;gap:1.5rem}:host ::ng-deep hra-page-section section hra-page-label h1{font:var(--mat-sys-title-large);letter-spacing:var(--mat-sys-title-large-tracking)}:host ::ng-deep hra-page-section section>.content{font:var(--mat-sys-body-large)!important;letter-spacing:var(--mat-sys-body-large-tracking)!important;margin-top:.5rem!important}\n"], dependencies: [{ kind: "ngmodule", type: HraCommonModule }, { kind: "directive", type: i1.ClickEventDirective, selector: "[hraClickEvent]", inputs: ["hraClickEvent", "hraClickEventTriggerOn", "hraClickEventDisabled"], exportAs: ["hraClickEvent"] }, { kind: "directive", type: i1.FeatureDirective, selector: "[hraFeature]", inputs: ["hraFeature"] }, { kind: "ngmodule", type: ButtonsModule }, { kind: "component", type: i2.MatIconButton, selector: "button[mat-icon-button], a[mat-icon-button], button[matIconButton], a[matIconButton]", exportAs: ["matButton", "matAnchor"] }, { kind: "component", type: i3.MatIcon, selector: "mat-icon", inputs: ["color", "inline", "svgIcon", "fontSet", "fontIcon"], exportAs: ["matIcon"] }, { kind: "ngmodule", type: MatIconModule }, { kind: "component", type: TableComponent, selector: "hra-table", inputs: ["csvUrl", "columns", "rows", "variant", "enableSort", "verticalDividers", "enableRowSelection", "hideHeaders"], outputs: ["selectionChange", "routeClicked", "downloadHovered"] }, { kind: "component", type: PageSectionComponent, selector: "hra-page-section", inputs: ["tagline", "level", "icons", "anchor", "breadcrumbs", "date", "tags"] }, { kind: "ngmodule", type: ScrollingModule }, { kind: "component", type: i4.NgScrollbar, selector: "ng-scrollbar:not([externalViewport]), [ngScrollbar]", exportAs: ["ngScrollbar"] }, { kind: "directive", type: i5.ScrollOverflowFadeDirective, selector: "[hraScrollOverflowFade]", inputs: ["scrollOverflowFadeOffset"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: BottomSheetComponent, decorators: [{
            type: Component,
...
class BottomSheetService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: BottomSheetService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: BottomSheetService, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: BottomSheetService, decorators: [{
            type: Injectable,
