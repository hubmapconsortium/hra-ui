...
class TextRowElementDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: TextRowElementDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.1.5", type: TextRowElementDirective, isStandalone: true, selector: "ng-template[hraTextRowElement]", ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: TextRowElementDirective, decorators: [{
            type: Directive,
            args: [{
...
class LinkRowElementDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: LinkRowElementDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.1.5", type: LinkRowElementDirective, isStandalone: true, selector: "ng-template[hraLinkRowElement]", ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: LinkRowElementDirective, decorators: [{
            type: Directive,
            args: [{
...
class MarkdownRowElementDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: MarkdownRowElementDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.1.5", type: MarkdownRowElementDirective, isStandalone: true, selector: "ng-template[hraMarkdownRowElement]", ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: MarkdownRowElementDirective, decorators: [{
            type: Directive,
            args: [{
...
class IconRowElementDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: IconRowElementDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.1.5", type: IconRowElementDirective, isStandalone: true, selector: "ng-template[hraIconRowElement]", ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: IconRowElementDirective, decorators: [{
            type: Directive,
            args: [{
...
class MenuButtonRowElementDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: MenuButtonRowElementDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.1.5", type: MenuButtonRowElementDirective, isStandalone: true, selector: "ng-template[hraMenuButtonRowElement]", ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: MenuButtonRowElementDirective, decorators: [{
            type: Directive,
            args: [{
...
class DataExplorationRowElementDirective {
    /* istanbul ignore next */
    /** Guard for the context of DataExploration Row Element */
    static ngTemplateContextGuard(_dir, _ctx) {
        return true;
    }
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: DataExplorationRowElementDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.1.5", type: DataExplorationRowElementDirective, isStandalone: true, selector: "ng-template[hraDataExplorationRowElement]", ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: DataExplorationRowElementDirective, decorators: [{
            type: Directive,
            args: [{
...
class NumericRowElementDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: NumericRowElementDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "21.1.5", type: NumericRowElementDirective, isStandalone: true, selector: "ng-template[hraNumericRowElement]", ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: NumericRowElementDirective, decorators: [{
            type: Directive,
            args: [{
...
class TableComponent {
    ...
    /** Table variant */
    variant = input('alternating', ...(ngDevMode ? [{ debugName: "variant" }] : []));
    /** Enables sorting */
    ...
    }, { ...(ngDevMode ? { debugName: "csv" } : {}), defaultValue: [],
        parse: (data) => {
     ...
     */
    openDataExplorationPreview(template, title, url) {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: TableComponent, decorators: [{
        ...
        }], ctorParameters: () => [], propDecorators: { csvUrl: [{ type: i0.Input, args: [{ isSignal: true, alias: "csvUrl", required: false }] }], columns: [{ type: i0.Input, args: [{ isSignal: true, alias: "columns", required: false }] }], rows: [{ type: i0.Input, args: [{ isSignal: true, alias: "rows", required: false }] }], variant: [{ type: i0.Input, args: [{ isSignal: true, alias: "variant", required: false }] }], enableSort: [{ type: i0.Input, args: [{ isSignal: true, alias: "enableSort", required: false }] }], verticalDividers: [{ type: i0.Input, args: [{ isSignal: true, alias: "verticalDividers", required: false }] }], enableRowSelection: [{ type: i0.Input, args: [{ isSignal: true, alias: "enableRowSelection", required: false }] }], hideHeaders: [{ type: i0.Input, args: [{ isSignal: true, alias: "hideHeaders", required: false }] }], selectionChange: [{ type: i0.Output, args: ["selectionChange"] }], routeClicked: [{ type: i0.Output, args: ["routeClicked"] }], downloadHovered: [{ type: i0.Output, args: ["downloadHovered"] }], scrollbar: [{ type: i0.ViewChild, args: ['scrollbar', { isSignal: true }] }], sort: [{ type: i0.ViewChild, args: [i0.forwardRef(() => MatSort), { isSignal: true }] }] } });

/** Schema for table variant */
const TableVariantSchema = z.enum(['alternating', 'divider', 'basic']).meta({ id: 'TableVariant' });
...
const TextColumnTypeSchema = z
    .object({
    type: z.literal('text'),
})
    .meta({ id: 'TextColumnType' });
/** Schema for Numeric Column */
const NumericColumnTypeSchema = z
    .object({
...
const MarkdownColumnTypeSchema = z
    .object({
    type: z.literal('markdown'),
})
    .meta({ id: 'MarkdownColumnType' });
/** Schema for Icon Column */
const IconColumnTypeSchema = z
    .object({
    type: z.literal('icon'),
    icon: z.string(),
...
const MenuButtonColumnTypeSchema = z
    .object({
    type: z.literal('menu'),
    icon: z.string(),
    options: z.string(),
...
const DataExplorationColumnTypeSchema = z
    .object({
