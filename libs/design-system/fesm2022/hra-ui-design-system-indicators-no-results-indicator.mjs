...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: NoResultsIndicatorComponent, decorators: [{
        ...
        }], propDecorators: { clearFilters: [{ type: i0.Output, args: ["clearFilters"] }] } });
