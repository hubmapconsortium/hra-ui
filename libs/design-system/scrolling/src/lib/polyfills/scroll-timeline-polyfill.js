...
!(function () {
  ...
  function mt(e) {
    ...
    if (!t) return;
    if (null == e)
      return void ('paused' !== t.proxy.playState && 'idle' != t.animation.playState && t.animation.cancel());
    dt(t),
      t.pendingTask &&
        requestAnimationFrame(() => {
    ...
    cancel() {
      ...
      e.timeline
        ? ('idle' != this.playState &&
            (!(function (e) {
              e.pendingTask &&
                ((e.pendingTask = null), rt(e), e.readyPromise.reject(Ye()), Xe(e), e.readyPromise.resolve(e.proxy));
            })(e),
  ...
  const It = new (class {
    ...
    transpileStyleSheet(e, t, n) {
      ...
      const { origin: r } = location;
      return i.sheetSrc.replace(/url\(("|'?)\.?\//gm, `url($1${r}/`);
    }
    ...
    handleScrollTimelineProps(e, t) {
      ...
      if ((this.saveSourceSelectorToScrollTimeline(e), this.saveSubjectSelectorToViewTimeline(e), !i && !n && !r))
        return;
      let o = [],
        s = [],
        a = !1;
