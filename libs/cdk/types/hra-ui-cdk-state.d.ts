...
/** Schema for link ID */
declare const LINK_ID_SCHEMA: z.core.$ZodBranded<z.ZodPipe<z.ZodString, z.ZodTransform<string, string>>, "LinkId", "out">;
...
declare const LINK_REGISTRY_SCHEMA: z.ZodRecord<z.core.$ZodBranded<z.ZodPipe<z.ZodString, z.ZodTransform<string, string>>, "LinkId", "out">, z.ZodDiscriminatedUnion<[z.ZodObject<{
    type: z.ZodLiteral<LinkType.External>;
    url: z.ZodString;
    rel: z.ZodOptional<z.ZodDefault<z.ZodString>>;
    target: z.ZodOptional<z.ZodString>;
...
declare const RESOURCE_ID: z.core.$ZodBranded<z.ZodPipe<z.ZodString, z.ZodTransform<string, string>>, "ResourceId", "out">;
...
/** State schema */
declare const RESOURCE_REGISTRY_SCHEMA: z.ZodRecord<z.core.$ZodBranded<z.ZodPipe<z.ZodString, z.ZodTransform<string, string>>, "ResourceId", "out">, z.ZodUnion<readonly [z.ZodDiscriminatedUnion<[z.ZodObject<{
    type: z.ZodLiteral<RawBuiltinResourceType.Markdown>;
    markdown: z.ZodString;
}, z.core.$strip>, z.ZodObject<{
    type: z.ZodLiteral<RawBuiltinResourceType.Text>;
