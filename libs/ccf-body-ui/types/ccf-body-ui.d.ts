...
declare const SPATIAL_SCENE_NODE: z.ZodType<SpatialSceneNode$1>;
/** Zod for SPATIAL SCENE NODE array */
declare const SPATIAL_SCENE_NODE_ARRAY: z.ZodArray<z.ZodType<SpatialSceneNode$1, unknown, z.core.$ZodTypeInternals<SpatialSceneNode$1, unknown>>>;
/** HRA Body UI Component */
declare class BodyUiComponent {
    /** Scene for the deck gl */
    readonly scene: _angular_core.InputSignalWithTransform<string | SpatialSceneNode$1[] | undefined, unknown>;
