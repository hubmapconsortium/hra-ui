...
import { SourceReference, Iri, CellSummary, IllustrationMappingItem, Url, TissueLibrary, Tissue } from '@hra-ui/services';
 ...
 */
declare const DOWNLOAD_FORMAT_ID: z.core.$ZodBranded<z.ZodPipe<z.ZodString, z.ZodTransform<string, string>>, "DownloadFormatId", "out">;
/**
...
declare const DOWNLOAD_FORMAT: z.ZodObject<{
    id: z.core.$ZodBranded<z.ZodPipe<z.ZodString, z.ZodTransform<string, string>>, "DownloadFormatId", "out">;
    label: z.ZodString;
...
declare const DOWNLOAD_MODEL: z.ZodObject<{
    formats: z.ZodRecord<z.core.$ZodBranded<z.ZodPipe<z.ZodString, z.ZodTransform<string, string>>, "DownloadFormatId", "out">, z.ZodObject<{
        id: z.core.$ZodBranded<z.ZodPipe<z.ZodString, z.ZodTransform<string, string>>, "DownloadFormatId", "out">;
        label: z.ZodString;
        extension: z.ZodOptional<z.ZodString>;
    }, z.core.$strip>>;
    entries: z.ZodRecord<z.core.$ZodBranded<z.ZodPipe<z.ZodString, z.ZodTransform<string, string>>, "DownloadFormatId", "out">, z.ZodDiscriminatedUnion<[z.ZodObject<{
        type: z.ZodLiteral<"url">;
        url: z.ZodString;
    }, z.core.$strip>, z.ZodObject<{
        type: z.ZodLiteral<"data">;
