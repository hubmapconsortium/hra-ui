...
export class LandingPageIntroComponent {
  ...
  /** Description for FTU */
  @Input() description = ` A functional tissue unit (FTU) is the smallest tissue organization that performs a unique physiologic function and
  ...
  /** message */
  @Input() thankyouMessage = `A special thanks to our partners: The FTU Explorer was designed in close collaboration with
