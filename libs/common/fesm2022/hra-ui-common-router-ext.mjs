...
class RouterExtModule {
    ...
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "20.3.15", ngImport: i0, type: RouterExtModule, imports: [LinkDirective, FragmentLinkDirective], exports: [LinkDirective, FragmentLinkDirective] });
