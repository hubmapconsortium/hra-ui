...
class DashboardComponentRegistryService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: DashboardComponentRegistryService, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: DashboardComponentRegistryService, providedIn: 'root' }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: DashboardComponentRegistryService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
class DashboardComponentOutletDirective {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: DashboardComponentOutletDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive }); }
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.1.0", version: "20.3.15", type: DashboardComponentOutletDirective, isStandalone: true, selector: "[hraDashboardComponentOutlet]", inputs: { hraDashboardComponentOutlet: { classPropertyName: "hraDashboardComponentOutlet", publicName: "hraDashboardComponentOutlet", isSignal: true, isRequired: true, transformFunction: null } }, ngImport: i0 }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: DashboardComponentOutletDirective, decorators: [{
            type: Directive,
            args: [{
...
class MetricsItemComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: MetricsItemComponent, deps: [], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.1.0", version: "20.3.15", type: MetricsItemComponent, isStandalone: true, selector: "hra-metrics-item", inputs: { spec: { classPropertyName: "spec", publicName: "spec", isSignal: true, isRequired: true, transformFunction: null } }, ngImport: i0, template: "<h4 class=\"count mat-subtitle-2\">{{ spec().count.toLocaleString() }} {{ spec().unit }}</h4>\n<div class=\"label mat-caption\">{{ spec().label }}</div>\n", styles: [":host{display:block}:host .count{font:var(--mat-sys-title-medium);letter-spacing:var(--mat-sys-title-medium-tracking);color:var(--mat-sys-on-tertiary-fixed);display:inline-block;margin:0;line-height:1.875rem}:host .label{font:var(--mat-sys-label-medium);letter-spacing:var(--mat-sys-label-medium-tracking);color:var(--mat-sys-on-secondary-fixed);line-height:1.3125rem}\n"], changeDetection: i0.ChangeDetectionStrategy.OnPush }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: MetricsItemComponent, decorators: [{
            type: Component,
...
class IframeContainerComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: IframeContainerComponent, deps: [], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.1.0", version: "20.3.15", type: IframeContainerComponent, isStandalone: true, selector: "hra-iframe-container", inputs: { spec: { classPropertyName: "spec", publicName: "spec", isSignal: true, isRequired: true, transformFunction: null } }, ngImport: i0, template: "<hra-title-card class=\"iframe-container\" [spec]=\"spec()\" [style.aspect-ratio]=\"spec().aspectRatio\">\n  <iframe [src]=\"iframeUrl()\" [attr.title]=\"spec().title\"></iframe>\n</hra-title-card>\n", styles: [":host{display:block}:host .iframe-container{width:100%}:host .iframe-container ::ng-deep .content{height:100%}:host .iframe-container ::ng-deep iframe{width:100%;height:100%;border:0px}\n"], dependencies: [{ kind: "ngmodule", type: CommonModule }, { kind: "component", type: TitleCardComponent, selector: "hra-title-card", inputs: ["spec"] }], changeDetection: i0.ChangeDetectionStrategy.OnPush }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.15", ngImport: i0, type: IframeContainerComponent, decorators: [{
            type: Component,
