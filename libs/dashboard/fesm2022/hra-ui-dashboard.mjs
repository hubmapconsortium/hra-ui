...
class DashboardComponentRegistryService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: DashboardComponentRegistryService, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: DashboardComponentRegistryService, providedIn: 'root' }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: DashboardComponentRegistryService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
class DashboardComponentOutletDirective {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: DashboardComponentOutletDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive }); }
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.1.0", version: "21.1.5", type: DashboardComponentOutletDirective, isStandalone: true, selector: "[hraDashboardComponentOutlet]", inputs: { hraDashboardComponentOutlet: { classPropertyName: "hraDashboardComponentOutlet", publicName: "hraDashboardComponentOutlet", isSignal: true, isRequired: true, transformFunction: null } }, ngImport: i0 }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: DashboardComponentOutletDirective, decorators: [{
            type: Directive,
            args: [{
...
class DashboardComponentOutletComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: DashboardComponentOutletComponent, deps: [], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.1.0", version: "21.1.5", type: DashboardComponentOutletComponent, isStandalone: true, selector: "hra-dashboard-component-outlet", inputs: { spec: { classPropertyName: "spec", publicName: "spec", isSignal: true, isRequired: true, transformFunction: null } }, ngImport: i0, template: `<ng-container *hraDashboardComponentOutlet="spec()" />`, isInline: true, dependencies: [{ kind: "directive", type: DashboardComponentOutletDirective, selector: "[hraDashboardComponentOutlet]", inputs: ["hraDashboardComponentOutlet"] }], changeDetection: i0.ChangeDetectionStrategy.OnPush }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: DashboardComponentOutletComponent, decorators: [{
            type: Component,
            args: [{
...
class LongCardComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: LongCardComponent, deps: [], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.1.0", version: "21.1.5", type: LongCardComponent, isStandalone: true, selector: "hra-long-card", inputs: { spec: { classPropertyName: "spec", publicName: "spec", isSignal: true, isRequired: true, transformFunction: null } }, ngImport: i0, template: "<ng-container hraFeature=\"spec-card\" [hraClickEvent]=\"{ title: spec().title | slugify }\">\n  <hra-visual-button [label]=\"spec().title\" [imageUrl]=\"spec().background\" (cardClick)=\"onClick()\" />\n</ng-container>\n", styles: [""], dependencies: [{ kind: "ngmodule", type: HraCommonModule }, { kind: "directive", type: i1.ClickEventDirective, selector: "[hraClickEvent]", inputs: ["hraClickEvent", "hraClickEventTriggerOn", "hraClickEventDisabled"], exportAs: ["hraClickEvent"] }, { kind: "directive", type: i1.FeatureDirective, selector: "[hraFeature]", inputs: ["hraFeature"] }, { kind: "ngmodule", type: MatIconModule }, { kind: "ngmodule", type: RouterModule }, { kind: "component", type: VisualButtonComponent, selector: "hra-visual-button", inputs: ["label", "imageUrl", "variant", "disabled"], outputs: ["cardClick"] }, { kind: "pipe", type: i2.SlugifyPipe, name: "slugify" }], changeDetection: i0.ChangeDetectionStrategy.OnPush }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: LongCardComponent, decorators: [{
            type: Component,
...
class GridContainerComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: GridContainerComponent, deps: [], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "21.1.5", type: GridContainerComponent, isStandalone: true, selector: "hra-grid-container", inputs: { spec: { classPropertyName: "spec", publicName: "spec", isSignal: true, isRequired: true, transformFunction: null } }, ngImport: i0, template: "<div data-testid=\"grid-container\" class=\"container\" [style.grid-template-columns]=\"columns()\">\n  @for (item of spec().items; track item) {\n    <ng-container *hraDashboardComponentOutlet=\"item\" />\n  }\n</div>\n", styles: [":host{display:block;margin-bottom:1.5rem}:host .container{display:grid;gap:1.5rem}@media(max-width:1012px){:host .container{grid-template-columns:1fr!important}:host .container ::ng-deep>*{min-width:42rem;min-height:33.875rem}}\n"], dependencies: [{ kind: "ngmodule", type: CommonModule }, { kind: "directive", type: DashboardComponentOutletDirective, selector: "[hraDashboardComponentOutlet]", inputs: ["hraDashboardComponentOutlet"] }], changeDetection: i0.ChangeDetectionStrategy.OnPush }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: GridContainerComponent, decorators: [{
            type: Component,
            args: [{ selector: 'hra-grid-container', imports: [CommonModule, DashboardComponentOutletDirective], changeDetection: ChangeDetectionStrategy.OnPush, template: "<div data-testid=\"grid-container\" class=\"container\" [style.grid-template-columns]=\"columns()\">\n  @for (item of spec().items; track item) {\n    <ng-container *hraDashboardComponentOutlet=\"item\" />\n  }\n</div>\n", styles: [":host{display:block;margin-bottom:1.5rem}:host .container{display:grid;gap:1.5rem}@media(max-width:1012px){:host .container{grid-template-columns:1fr!important}:host .container ::ng-deep>*{min-width:42rem;min-height:33.875rem}}\n"] }]
        }], propDecorators: { spec: [{ type: i0.Input, args: [{ isSignal: true, alias: "spec", required: true }] }] } });
...
class ImageContainerComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: ImageContainerComponent, deps: [], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.1.0", version: "21.1.5", type: ImageContainerComponent, isStandalone: true, selector: "hra-image-container", inputs: { spec: { classPropertyName: "spec", publicName: "spec", isSignal: true, isRequired: true, transformFunction: null } }, ngImport: i0, template: "<hra-title-card class=\"card\" [spec]=\"spec()\">\n  <img [attr.src]=\"spec().imageUrl\" [style.aspect-ratio]=\"spec().aspectRatio\" [alt]=\"spec().tooltip\" />\n</hra-title-card>\n", styles: [":host{display:block;height:100%}:host .card{width:100%;height:100%}:host .card img{width:100%;object-fit:contain;border-radius:1rem}\n"], dependencies: [{ kind: "ngmodule", type: CommonModule }, { kind: "component", type: TitleCardComponent, selector: "hra-title-card", inputs: ["spec"] }], changeDetection: i0.ChangeDetectionStrategy.OnPush }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: ImageContainerComponent, decorators: [{
            type: Component,
            args: [{ selector: 'hra-image-container', imports: [CommonModule, TitleCardComponent], changeDetection: ChangeDetectionStrategy.OnPush, template: "<hra-title-card class=\"card\" [spec]=\"spec()\">\n  <img [attr.src]=\"spec().imageUrl\" [style.aspect-ratio]=\"spec().aspectRatio\" [alt]=\"spec().tooltip\" />\n</hra-title-card>\n", styles: [":host{display:block;height:100%}:host .card{width:100%;height:100%}:host .card img{width:100%;object-fit:contain;border-radius:1rem}\n"] }]
        }], propDecorators: { spec: [{ type: i0.Input, args: [{ isSignal: true, alias: "spec", required: true }] }] } });
...
class MetricsItemComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: MetricsItemComponent, deps: [], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.1.0", version: "21.1.5", type: MetricsItemComponent, isStandalone: true, selector: "hra-metrics-item", inputs: { spec: { classPropertyName: "spec", publicName: "spec", isSignal: true, isRequired: true, transformFunction: null } }, ngImport: i0, template: "<h4 class=\"count mat-subtitle-2\">{{ spec().count.toLocaleString() }} {{ spec().unit }}</h4>\n<div class=\"label mat-caption\">{{ spec().label }}</div>\n", styles: [":host{display:block}:host .count{font:var(--mat-sys-title-medium);letter-spacing:var(--mat-sys-title-medium-tracking);color:var(--mat-sys-on-tertiary-fixed);display:inline-block;margin:0;line-height:1.875rem}:host .label{font:var(--mat-sys-label-medium);letter-spacing:var(--mat-sys-label-medium-tracking);color:var(--mat-sys-on-secondary-fixed);line-height:1.3125rem}\n"], changeDetection: i0.ChangeDetectionStrategy.OnPush }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: MetricsItemComponent, decorators: [{
            type: Component,
...
class MetricsContainerComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: MetricsContainerComponent, deps: [], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "21.1.5", type: MetricsContainerComponent, isStandalone: true, selector: "hra-dashboard-metrics-container", inputs: { spec: { classPropertyName: "spec", publicName: "spec", isSignal: true, isRequired: true, transformFunction: null } }, ngImport: i0, template: "@for (item of spec().items; track item) {\n  <hra-title-card class=\"card\" data-testid=\"title-card\" [spec]=\"item\" [class.span-columns]=\"isWideCardAt($index)\">\n    <div class=\"items\" data-testid=\"metrics-group\">\n      @for (metric of item.items; track metric) {\n        <hra-metrics-item data-testid=\"metrics-item\" [spec]=\"metric\" />\n      }\n    </div>\n  </hra-title-card>\n}\n", styles: [":host{display:grid;grid-template-columns:1fr 1fr;gap:.75rem}:host .card .items{display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:1rem;border-top:solid 1px #d5dbe3;padding-top:1rem}:host .span-columns{grid-column:1/3}\n"], dependencies: [{ kind: "component", type: TitleCardComponent, selector: "hra-title-card", inputs: ["spec"] }, { kind: "component", type: MetricsItemComponent, selector: "hra-metrics-item", inputs: ["spec"] }] }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: MetricsContainerComponent, decorators: [{
            type: Component,
...
class VegaContainerComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: VegaContainerComponent, deps: [], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.2.0", version: "21.1.5", type: VegaContainerComponent, isStandalone: true, selector: "hra-vega-container", inputs: { spec: { classPropertyName: "spec", publicName: "spec", isSignal: true, isRequired: true, transformFunction: null } }, viewQueries: [{ propertyName: "visRef", first: true, predicate: ["vis"], descendants: true, isSignal: true }], ngImport: i0, template: "<hra-title-card class=\"card\" [spec]=\"spec()\">\n  <div class=\"visualization\" data-testid=\"visualization\" [style.aspect-ratio]=\"spec().aspectRatio\" #vis></div>\n</hra-title-card>\n", styles: [":host{display:block}:host .card{width:100%}:host .card .visualization{width:100%;display:flex;align-items:center;justify-content:center}:host .card .visualization ::ng-deep canvas,:host .card .visualization ::ng-deep svg{max-width:100%!important;width:100%!important;height:auto!important;display:block!important}::ng-deep #vg-tooltip-element.vg-tooltip{font-family:Metropolis;font-weight:500;font-size:.75rem;line-height:1.125rem;color:#201e3d;padding:.5rem;max-width:22.5rem;box-shadow:0 5px 16px #201e3d3d}::ng-deep #vg-tooltip-element.vg-tooltip table tbody tr:not(:last-child){margin-bottom:4px}::ng-deep #vg-tooltip-element.vg-tooltip table tbody tr td:first-child{color:#201e3d;text-align:left}::ng-deep #vg-tooltip-element.vg-tooltip table tbody tr td:last-child{color:#4b4b5e}\n"], dependencies: [{ kind: "ngmodule", type: CommonModule }, { kind: "component", type: TitleCardComponent, selector: "hra-title-card", inputs: ["spec"] }], changeDetection: i0.ChangeDetectionStrategy.OnPush }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: VegaContainerComponent, decorators: [{
            type: Component,
            args: [{ selector: 'hra-vega-container', imports: [CommonModule, TitleCardComponent], changeDetection: ChangeDetectionStrategy.OnPush, template: "<hra-title-card class=\"card\" [spec]=\"spec()\">\n  <div class=\"visualization\" data-testid=\"visualization\" [style.aspect-ratio]=\"spec().aspectRatio\" #vis></div>\n</hra-title-card>\n", styles: [":host{display:block}:host .card{width:100%}:host .card .visualization{width:100%;display:flex;align-items:center;justify-content:center}:host .card .visualization ::ng-deep canvas,:host .card .visualization ::ng-deep svg{max-width:100%!important;width:100%!important;height:auto!important;display:block!important}::ng-deep #vg-tooltip-element.vg-tooltip{font-family:Metropolis;font-weight:500;font-size:.75rem;line-height:1.125rem;color:#201e3d;padding:.5rem;max-width:22.5rem;box-shadow:0 5px 16px #201e3d3d}::ng-deep #vg-tooltip-element.vg-tooltip table tbody tr:not(:last-child){margin-bottom:4px}::ng-deep #vg-tooltip-element.vg-tooltip table tbody tr td:first-child{color:#201e3d;text-align:left}::ng-deep #vg-tooltip-element.vg-tooltip table tbody tr td:last-child{color:#4b4b5e}\n"] }]
...
class IframeContainerComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: IframeContainerComponent, deps: [], target: i0.ɵɵFactoryTarget.Component }); }
    static { this.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.1.0", version: "21.1.5", type: IframeContainerComponent, isStandalone: true, selector: "hra-iframe-container", inputs: { spec: { classPropertyName: "spec", publicName: "spec", isSignal: true, isRequired: true, transformFunction: null } }, ngImport: i0, template: "<hra-title-card class=\"iframe-container\" [spec]=\"spec()\" [style.aspect-ratio]=\"spec().aspectRatio\">\n  <iframe [src]=\"iframeUrl()\" [attr.title]=\"spec().title\"></iframe>\n</hra-title-card>\n", styles: [":host{display:block}:host .iframe-container{width:100%}:host .iframe-container ::ng-deep .content{height:100%}:host .iframe-container ::ng-deep iframe{width:100%;height:100%;border:0px}\n"], dependencies: [{ kind: "ngmodule", type: CommonModule }, { kind: "component", type: TitleCardComponent, selector: "hra-title-card", inputs: ["spec"] }], changeDetection: i0.ChangeDetectionStrategy.OnPush }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: IframeContainerComponent, decorators: [{
            type: Component,
            args: [{ selector: 'hra-iframe-container', imports: [CommonModule, TitleCardComponent], changeDetection: ChangeDetectionStrategy.OnPush, template: "<hra-title-card class=\"iframe-container\" [spec]=\"spec()\" [style.aspect-ratio]=\"spec().aspectRatio\">\n  <iframe [src]=\"iframeUrl()\" [attr.title]=\"spec().title\"></iframe>\n</hra-title-card>\n", styles: [":host{display:block}:host .iframe-container{width:100%}:host .iframe-container ::ng-deep .content{height:100%}:host .iframe-container ::ng-deep iframe{width:100%;height:100%;border:0px}\n"] }]
        }], propDecorators: { spec: [{ type: i0.Input, args: [{ isSignal: true, alias: "spec", required: true }] }] } });
