...
class GradientLegendComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.12", ngImport: i0, type: GradientLegendComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.12", type: GradientLegendComponent, isStandalone: true, selector: "ftu-gradient-legend", inputs: { gradient: "gradient" }, ngImport: i0, template: "<div class=\"start\">0.0</div>\n<div class=\"gradient-bar\" [style.background]=\"gradientCss\"></div>\n<div class=\"end\">1.0</div>\n", styles: [":host{display:flex;flex-direction:rows;align-items:center;justify-content:center;gap:.25rem}:host .start,:host .end{font:var(--mat-sys-label-micro);letter-spacing:var(--mat-sys-label-micro-tracking)}:host .gradient-bar{height:1.25rem;width:100%}\n"], dependencies: [{ kind: "ngmodule", type: CommonModule }], changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.12", ngImport: i0, type: GradientLegendComponent, decorators: [{
            type: Component,
...
class LabelBoxComponent {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.12", ngImport: i0, type: LabelBoxComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.12", type: LabelBoxComponent, isStandalone: true, selector: "ftu-label-box", ngImport: i0, template: "<ng-content />\n<ng-content select=\".end\" />\n", styles: [":host{font:var(--mat-sys-label-medium);letter-spacing:var(--mat-sys-label-medium-tracking);display:flex;align-items:center;padding:.75rem .5rem 1rem 1rem;min-height:4rem}\n"], dependencies: [{ kind: "ngmodule", type: CommonModule }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.12", ngImport: i0, type: LabelBoxComponent, decorators: [{
            type: Component,
...
class BiomarkerTableDataIconComponent {
    ...
    size = 0;
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.12", ngImport: i0, type: BiomarkerTableDataIconComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "20.3.12", type: BiomarkerTableDataIconComponent, isStandalone: true, selector: "ftu-biomarker-table-data-icon", inputs: { color: "color", size: "size" }, host: { properties: { "style.background-color": "color", "style.--radius.rem": "size" } }, ngImport: i0, template: '', isInline: true, styles: [":host{display:block;border-radius:50%;--radius: .625rem;width:var(--radius);height:var(--radius)}\n"], dependencies: [{ kind: "ngmodule", type: CommonModule }], changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.12", ngImport: i0, type: BiomarkerTableDataIconComponent, decorators: [{
            type: Component,
...
class FtuFullScreenService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.12", ngImport: i0, type: FtuFullScreenService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "20.3.12", ngImport: i0, type: FtuFullScreenService, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.12", ngImport: i0, type: FtuFullScreenService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
