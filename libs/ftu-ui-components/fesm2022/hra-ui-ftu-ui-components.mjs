...
class SourceListComponent {
    ...
    sourceTable = viewChild('sourceTable', ...(ngDevMode ? [{ debugName: "sourceTable" }] : []));
    ...
    constructor() {
        effect(() => {
            ...
            if (table && sources.length > 0) {
                ...
                this.selectionChanged.emit(table.selection.selected);
            }
        });
    }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: SourceListComponent, decorators: [{
        ...
        }], ctorParameters: () => [], propDecorators: { sources: [{ type: i0.Input, args: [{ isSignal: true, alias: "sources", required: false }] }], message: [{ type: i0.Input, args: [{ isSignal: true, alias: "message", required: false }] }], hideTitle: [{ type: i0.Input, args: [{ isSignal: true, alias: "hideTitle", required: false }] }], selectionChanged: [{ type: i0.Output, args: ["selectionChanged"] }], sourceTable: [{ type: i0.ViewChild, args: ['sourceTable', { isSignal: true }] }] } });
