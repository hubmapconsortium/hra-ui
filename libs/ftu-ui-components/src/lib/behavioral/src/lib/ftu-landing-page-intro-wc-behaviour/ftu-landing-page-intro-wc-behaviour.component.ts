...
import { HraLandingPageIntroWcComponent } from '../../../../molecules/src';
...
@Component({
  ...
  templateUrl: './ftu-landing-page-intro-wc-behaviour.component.html',
  styleUrls: ['./ftu-landing-page-intro-wc-behaviour.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class FtuLandingPageIntroWcBehaviourComponent {
