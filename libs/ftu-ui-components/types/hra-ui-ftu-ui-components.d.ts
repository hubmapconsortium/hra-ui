...
import { TemplateRef, OnChanges, OnDestroy, SimpleChanges, EventEmitter, ElementRef } from '@angular/core';
...
declare class InteractiveSvgComponent<T extends NodeMapEntry> implements OnChanges, OnDestroy {
    ...
    readonly NEVER_EVAL_SCRIPTS: SVGScriptEvalMode;
...
declare class BiomarkerDetailsComponent {
    ...
    readonly gradientHoverInfo: <Res = string, Args extends _hra_ui_utils_types_hra_ui_utils_types.Any[] = []>(...args: Args) => Res;
    /** Info to be shown on the tooltip for Size Legend */
    readonly sizeHoverInfo: <Res = string, Args extends _hra_ui_utils_types_hra_ui_utils_types.Any[] = []>(...args: Args) => Res;
...
declare class MedicalIllustrationBehaviorComponent {
    ...
    readonly updateNodeOnHover: (selectedOnHover: {
        ...
        readonly selectedOnHover: dist_libs_services_types_hra_ui_services.IllustrationMappingItem | undefined;
        readonly type: string;
    };
    /**
    ...
    readonly updateNodeOnClicked: (selectedOnClick: {
        ...
        readonly selectedOnClick: dist_libs_services_types_hra_ui_services.IllustrationMappingItem;
        readonly type: string;
    };
