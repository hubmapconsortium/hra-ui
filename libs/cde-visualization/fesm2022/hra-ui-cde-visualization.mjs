...
import { DEFAULT_MAX_EDGE_DISTANCE, DEFAULT_NODE_TARGET_SELECTOR } from '@hra-ui/node-dist-vis';
...
class FileSaverService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: FileSaverService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: FileSaverService, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: FileSaverService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
class HistogramComponent {
    ...
    totalCellTypeColor = signal([0, 0, 0], { ...(ngDevMode ? { debugName: "totalCellTypeColor" } : {}), equal: colorEquals });
...
class DefaultToPipe {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: DefaultToPipe, deps: [], target: i0.ɵɵFactoryTarget.Pipe });
    static ɵpipe = i0.ɵɵngDeclarePipe({ minVersion: "14.0.0", version: "21.1.5", ngImport: i0, type: DefaultToPipe, isStandalone: true, name: "defaultTo" });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: DefaultToPipe, decorators: [{
            type: Pipe,
            args: [{
                    name: 'defaultTo',
                    pure: true,
...
class NodeDistVisualizationMenuComponent {
    ...
    fullscreenMode = input(false, { ...(ngDevMode ? { debugName: "fullscreenMode" } : {}), transform: booleanAttribute });
...
class ViolinMenuComponent {
    ...
    /** Event to emit to download assets */
    download = output();
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: ViolinMenuComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "21.1.5", type: ViolinMenuComponent, isStandalone: true, selector: "cde-violin-menu", inputs: { dialogOpen: { classPropertyName: "dialogOpen", publicName: "dialogOpen", isSignal: true, isRequired: false, transformFunction: null } }, outputs: { open: "open", download: "download" }, ngImport: i0, template: "<button\n  mat-icon-button\n  hraIconButtonSize=\"large\"\n  aria-label=\"Icon to open nested menu\"\n  hraPlainTooltip=\"More\"\n  hraClickEvent\n  [matMenuTriggerFor]=\"menu\"\n  (click)=\"$event.stopPropagation()\"\n>\n  <mat-icon>more_vert</mat-icon>\n</button>\n<mat-menu class=\"violin-overlay\" #menu=\"matMenu\">\n  <button\n    mat-menu-item\n    matRipple\n    matRippleColor=\"#201E3D14\"\n    hraFeature=\"info\"\n    hraClickEvent\n    hraHoverEvent\n    hraHoverEventTriggerOn=\"mouseenter\"\n    [matMenuTriggerFor]=\"infoSubMenu\"\n    (click)=\"$event.stopImmediatePropagation()\"\n  >\n    <mat-icon>info</mat-icon>\n    <span>Info</span>\n    <mat-icon class=\"expand-arrow\">arrow_right</mat-icon>\n  </button>\n  <button\n    mat-menu-item\n    matRipple\n    matRippleColor=\"#201E3D14\"\n    hraFeature=\"download\"\n    hraClickEvent\n    [matMenuTriggerFor]=\"downloadSubMenu\"\n    (click)=\"$event.stopImmediatePropagation()\"\n  >\n    <mat-icon>download</mat-icon>\n    <span>Downloads</span>\n    <mat-icon class=\"expand-arrow\">arrow_right</mat-icon>\n  </button>\n  @if (!dialogOpen()) {\n    <button mat-menu-item hraFeature=\"fullscreen\" hraClickEvent (click)=\"open.emit()\">\n      <mat-icon>fullscreen</mat-icon>\n      Full Screen\n    </button>\n  }\n  <a\n    mat-menu-item\n    href=\"https://github.com/hubmapconsortium/hra-ui/blob/main/apps/cde-visualization-wc/EMBEDDING.md\"\n    target=\"_blank\"\n    rel=\"noopener noreferrer\"\n    hraFeature=\"embed-app\"\n    hraClickEvent\n  >\n    <mat-icon>code</mat-icon>\n    Embed App\n  </a>\n  <mat-menu class=\"info-sub-menu\" hraFeature=\"violin-info-submenu\" #infoSubMenu=\"matMenu\">\n    This violin plot shows a cell-to-nearest-anchor cell distance distributions categorized by each cell type in the\n    dataset.\n  </mat-menu>\n  <mat-menu class=\"download-sub-menu\" hraFeature=\"download\" #downloadSubMenu=\"matMenu\">\n    <button\n      mat-menu-item\n      hraFeature=\"download-png\"\n      hraClickEvent\n      (click)=\"$event.stopPropagation(); download.emit('png')\"\n    >\n      <mat-icon>download</mat-icon>\n      PNG\n    </button>\n    <button\n      mat-menu-item\n      hraFeature=\"download-svg\"\n      hraClickEvent\n      (click)=\"$event.stopPropagation(); download.emit('svg')\"\n    >\n      <mat-icon>download</mat-icon>\n      SVG\n    </button>\n  </mat-menu>\n</mat-menu>\n", styles: [":host{display:block}\n"], dependencies: [{ kind: "ngmodule", type: HraCommonModule }, { kind: "directive", type: i1.ClickEventDirective, selector: "[hraClickEvent]", inputs: ["hraClickEvent", "hraClickEventTriggerOn", "hraClickEventDisabled"], exportAs: ["hraClickEvent"] }, { kind: "directive", type: i1.FeatureDirective, selector: "[hraFeature]", inputs: ["hraFeature"] }, { kind: "directive", type: i1.HoverEventDirective, selector: "[hraHoverEvent]", inputs: ["hraHoverEvent", "hraHoverEventTriggerOn", "hraHoverEventDisabled"], exportAs: ["hraHoverEvent"] }, { kind: "ngmodule", type: MatIconModule }, { kind: "component", type: i2.MatIcon, selector: "mat-icon", inputs: ["color", "inline", "svgIcon", "fontSet", "fontIcon"], exportAs: ["matIcon"] }, { kind: "ngmodule", type: MatMenuModule }, { kind: "component", type: i3.MatMenu, selector: "mat-menu", inputs: ["backdropClass", "aria-label", "aria-labelledby", "aria-describedby", "xPosition", "yPosition", "overlapTrigger", "hasBackdrop", "class", "classList"], outputs: ["closed", "close"], exportAs: ["matMenu"] }, { kind: "component", type: i3.MatMenuItem, selector: "[mat-menu-item]", inputs: ["role", "disabled", "disableRipple"], exportAs: ["matMenuItem"] }, { kind: "directive", type: i3.MatMenuTrigger, selector: "[mat-menu-trigger-for], [matMenuTriggerFor]", inputs: ["mat-menu-trigger-for", "matMenuTriggerFor", "matMenuTriggerData", "matMenuTriggerRestoreFocus"], outputs: ["menuOpened", "onMenuOpen", "menuClosed", "onMenuClose"], exportAs: ["matMenuTrigger"] }, { kind: "ngmodule", type: ButtonsModule }, { kind: "component", type: i2$2.MatIconButton, selector: "button[mat-icon-button], a[mat-icon-button], button[matIconButton], a[matIconButton]", exportAs: ["matButton", "matAnchor"] }, { kind: "directive", type: i5$1.IconButtonSizeDirective, selector: "[hraIconButtonSize]", inputs: ["hraIconButtonSize"] }], changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: ViolinMenuComponent, decorators: [{
            type: Component,
...
class CdeVisualizationComponent {
    ...
    /** Age of the subject */
    age = input(undefined, { ...(ngDevMode ? { debugName: "age" } : {}), transform: numberAttribute() });
    /** Thickness of the sample */
    thickness = input(undefined, { ...(ngDevMode ? { debugName: "thickness" } : {}), transform: numberAttribute() });
    /** Pixel size in the visualization */
    pixelSize = input(undefined, { ...(ngDevMode ? { debugName: "pixelSize" } : {}), transform: numberAttribute() });
    /** Creation timestamp (ms since 1/1/1970 UTC) */
    creationTimestamp = input(undefined, { ...(ngDevMode ? { debugName: "creationTimestamp" } : {}), transform: numberAttribute() });
    ...
    /** List of selected cell types */
    cellTypesSelection = signal([], { ...(ngDevMode ? { debugName: "cellTypesSelection" } : {}), equal: emptyArrayEquals });
    ...
    }, { ...(ngDevMode ? { debugName: "filteredCellTypes" } : {}), equal: emptyArrayEquals });
    /** Computed distances between nodes */
    distances = computed(() => this.computeDistances(), { ...(ngDevMode ? { debugName: "distances" } : {}), equal: emptyArrayEquals });
    /** Data for the histogram visualization */
    filteredDistances = computed(() => this.computeFilteredDistances(), { ...(ngDevMode ? { debugName: "filteredDistances" } : {}), equal: emptyArrayEquals });
    /** Colors for the histogram visualization */
    filteredColors = computed(() => this.computeFilteredColors(), { ...(ngDevMode ? { debugName: "filteredColors" } : {}), equal: emptyArrayEquals });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.5", ngImport: i0, type: ColorMapFileLoaderService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
