...
var require_papaparse_min = __commonJS({
  "node_modules/papaparse/papaparse.min.js"(exports, module) {
    "use strict";
    ((e, t) => {
      false ? (void 0)([], t) : "object" == typeof module && "undefined" != typeof exports ? module.exports = t() : e.Papa = t();
    })(exports, function r() {
...
function cachedAccessor(instance, accessor) {
  const cacheKey = /* @__PURE__ */ Symbol();
  const obj = instance;
  return () => {
...
var DATA_VIEW_HEADER = /* @__PURE__ */ Symbol("DataView header");
...
function createDataViewClass(keys) {
  class DataViewImpl {
    constructor(data, keyMapping, offset = 0) {
      ...
      this.offset = offset;
      this.keys = keys;
      this.at = (index) => this.data[this.offset + index];
      this.getPropertyAt = (index, property) => {
        return this.getPropertyFor(this.data[this.offset + index] ?? {}, property);
      };
      this.getPropertyFor = (obj, property) => {
      ...
      this.materializeAt = (index, keyMapping) => {
        return this.materializeFor(this.at(index), keyMapping);
      };
      this.materializeFor = (obj, keyMapping) => {
...
var NodesView = class extends BaseNodesView {
  constructor() {
     ...
     */
    this.getPositionAt = (index, info) => this.getPositionFor(this.at(index), info);
    /**
     * Get the position of a node.
     * If an accessor context is provided the preallocated target
     * array will be filled out and returned instead of a new array.
     ...
     */
    this.getDimensions3D = cachedAccessor(this, () => {
     ...
     */
    this.getDimensions = cachedAccessor(this, () => {
     ...
     */
    this.getScale3D = cachedAccessor(this, () => {
      const [[minX, maxX], [minY, maxY], [minZ, maxZ]] = this.getDimensions3D();
     ...
     */
    this.getScale = cachedAccessor(this, () => {
     ...
     */
    this.getCenter = cachedAccessor(this, () => {
      const [[minX, maxX], [minY, maxY], [minZ, maxZ]] = this.getDimensions3D();
     ...
     */
    this.getCounts = cachedAccessor(this, () => {
      const counts = {};
      for (const obj of this) {
     ...
     * @returns A new index
     */
    this.createReindexer = async (filterView) => {
...
// libs/node-dist-vis/models/src/lib/edges/generator.worker.ts
function createProgressMessage(processed, total) {
  return {
    type: "progress",
    processed,
    total,
...
function createResultMessage(edges) {
  return {
    type: "result",
    edges: {
      data: edges,
...
//# sourceMappingURL=worker-532HCJ33.js.map
