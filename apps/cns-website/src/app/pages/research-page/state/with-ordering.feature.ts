...
const GROUP_BY_KEY_LABELS: Record<GroupByKey, string> = {
  '': '',
  unknown: 'Unknown',
  ['data-tool' as ResearchItemType]: 'Data & tools',
  ['event' as ResearchItemType]: 'Events',
  ['funding' as ResearchItemType]: 'Funding',
  ['display' as ResearchItemType]: 'Interactive displays',
  ['miscellaneous' as ResearchItemType]: 'Miscellaneous',
  ['news' as ResearchItemType]: 'News',
  ['presentation' as ResearchItemType]: 'Presentations',
  ['publication' as ResearchItemType]: 'Publications',
  ['software' as ResearchItemType]: 'Software Products',
  ['teaching' as ResearchItemType]: 'Teaching',
  ['visualization' as ResearchItemType]: 'Visualizations',
