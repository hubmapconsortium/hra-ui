...
export const DEFAULT_ICONS: DefaultIconDefinition[] = [
  ...
  { name: 'manubrium', namespace: 'app', url: 'assets/icons/organ-icons/organ-icon-manubrium.svg' },
  ...
  { name: 'renal-pelvis-left', namespace: 'app', url: 'assets/icons/organ-icons/organ-icon-renal-pelvis-left.svg' },
  { name: 'renal-pelvis-right', namespace: 'app', url: 'assets/icons/organ-icons/organ-icon-renal-pelvis-right.svg' },
  ...
  { name: 'sternum', namespace: 'app', url: 'assets/icons/organ-icons/organ-icon-sternum.svg' },
