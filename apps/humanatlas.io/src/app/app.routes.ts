...
import { createPublicationsResolver } from './resolvers/publications.resolver';
...
export const appRoutes: Route[] = [
  ...
  },
  {
    ...
    component: AppLayoutComponent,
    resolve: {
      data: createPublicationsResolver('https://cns.iu.edu/publications.json?sort=hra', AppLayoutDataSchema),
    },
  },
  {
