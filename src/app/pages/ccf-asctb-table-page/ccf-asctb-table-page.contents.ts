...
export const exploreTablesData: PageDataItems[] = [
    ...
    },
    {
        ...
        descriptions: 'The initial release of ASCT+B table (v1.0) included 11 organs. As part of the next phase, we plan to publish another 14 tables by the end of 2021 bringing the total to 25. If you are interested in contributing to this effort, please complete this online form to receive relevant information and meeting invites. For questions, email infoccf@indiana.edu.'
    },
    {
