...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">Code Documentation for cde-ui</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/CreateVisualizationPageComponent.html" data-type="entity-link" >CreateVisualizationPageComponent</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/SourceDataMenuComponent.html" data-type="entity-link" >SourceDataMenuComponent</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/VisualizationPageComponent.html" data-type="entity-link" >VisualizationPageComponent</a>
                            </li>
                        </ul>
                    </li>
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="directives-links"' : 'id="xs-directives-links"' }>
                                <li class="link">
                                    <a href="directives/MarkEmptyFormControlDirective.html" data-type="entity-link" >MarkEmptyFormControlDirective</a>
                                </li>
                            </ul>
                        </li>
                    <li class="chapter">
                        ...
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                <li class="link">
                                    <a href="injectables/VisualizationDataService.html" data-type="entity-link" >VisualizationDataService</a>
                                </li>
                            </ul>
                        </li>
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/JsonFileResolverOptions.html" data-type="entity-link" >JsonFileResolverOptions</a>
                            </li>
                            <li class="link">
