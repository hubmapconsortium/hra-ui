...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">Code Documentation for cdk</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="directives-links"' : 'id="xs-directives-links"' }>
                                <li class="link">
                                    <a href="directives/ContentTemplateOutletDirective.html" data-type="entity-link" >ContentTemplateOutletDirective</a>
                                </li>
                                <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                ...
                                <li class="link">
                                    <a href="injectables/ContentTemplateControllerRegistryService.html" data-type="entity-link" >ContentTemplateControllerRegistryService</a>
                                </li>
                                <li class="link">
                                    <a href="injectables/ContentTemplateDefRegistryService.html" data-type="entity-link" >ContentTemplateDefRegistryService</a>
                                </li>
                                <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/ContentTemplateController.html" data-type="entity-link" >ContentTemplateController</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/ContentTemplateControllerConstructor.html" data-type="entity-link" >ContentTemplateControllerConstructor</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/ContentTemplateDef.html" data-type="entity-link" >ContentTemplateDef</a>
                            </li>
                            <li class="link">
