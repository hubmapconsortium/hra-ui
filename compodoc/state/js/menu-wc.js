...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">Code Documentation for state</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                            ...
                            <li class="link">
                                <a href="classes/AggregateBuilder.html" data-type="entity-link" >AggregateBuilder</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="classes/CombineSummariesByBiomarker.html" data-type="entity-link" >CombineSummariesByBiomarker</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="classes/ResetSelectedSources.html" data-type="entity-link" >ResetSelectedSources</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="classes/SetSelectedSources.html" data-type="entity-link" >SetSelectedSources</a>
                            </li>
                            <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/SourceRefsModel.html" data-type="entity-link" >SourceRefsModel</a>
                            </li>
                        </ul>
                    </li>
                    <li class="chapter">
